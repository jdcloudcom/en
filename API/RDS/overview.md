...
|**createBackupSynchronicity**|POST|Create a cross-region backup synchronization service. <br>- Only support MySQL|
...
|**deleteBackupSynchronicity**|DELETE|Delete a cross-region backup synchronization service. <br>- Only support MySQL|
...
|**deleteParameterGroup**|DELETE|Delete parameter set<br>- Support MySQL only|
