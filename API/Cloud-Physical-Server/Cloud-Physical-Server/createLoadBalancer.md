...
|**loadBalancerSpec**|[LoadBalancerSpec](createloadbalancer#loadbalancerspec)|True| |Load Balancer Configuration|

### <div id="loadbalancerspec">LoadBalancerSpec</div>
|Name|Type|Required or Not|Default Value|Description|
|---|---|---|---|---|
|**netType**|String|True| |Network Type, with the value public|
|**ipAddressType**|String|True| |IP version of Load Balancer instance, with the value ipv4|
|**vpcId**|String|True| |VPC ID|
|**name**|String|True| |Name|
|**description**|String|False| |Description|
|**applyElasticIp**|Boolean|True| |Apply for Elastic Ip or not|
|**bandwidth**|Integer|True| |Bandwidth|
|**charge**|[ChargeSpec](createloadbalancer#chargespec)|True| |Billing Configuration|
