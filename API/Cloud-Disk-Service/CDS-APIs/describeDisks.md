...
|**filters**|Filter[]|False| |diskId - Cloud Disk ID, accuracy match, supporting multiple IDs<br>diskType - Cloud Disk types, accuracy match, supporting multiple types, values are ssd, premium-hdd, ssd.io1, ssd.gp1 and hdd.std1<br>instanceId - ID of the Virtual Machines attached by the Cloud Disk, accuracy match, supporting multiple IDs<br>instanceType - types of the Virtual Machines attached by the Cloud Disk, accuracy match, supporting multiple types<br>az - availability zone, accuracy match, supporting multiple availability zones<br>status - Cloud Disk status, accurate match, supporting multiple statuses<br>name - Disk name, fuzzy match, supporting a single name<br>multiAttach - whether the Cloud Disk is attached to multiple points, accurate match, supporting the single point match<br>encrypted - Whether the Cloud Disk is encrypted, accurate match, supporting single encryption<br>|
