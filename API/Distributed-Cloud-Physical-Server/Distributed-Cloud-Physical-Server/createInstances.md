...
|**instanceSpec**|[InstanceSpec](createinstances#instancespec)|True| |Describe configuration of Distributed Cloud Physical Server|
...
|**aliasIps**|[AliasIpInfo[]](createinstances#aliasipinfo)|False| |Alias ip Configuration|
