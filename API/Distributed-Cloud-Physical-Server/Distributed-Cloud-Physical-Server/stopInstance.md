...
## Description
Shut down a single Distributed Cloud Physical Server and only servers in the running status can be stopped<br>Sensitive operation can be enabled<a href="https://docs.jdcloud.com/en/security-operation-protection/operation-protection">MFA Operation Protection</a>
...
|Name|Type|Description|
|---|---|---|
|**success**|Boolean|Whether the shutdown operation succeeded|
