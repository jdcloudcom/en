...
|**bandwidth**|Integer|True| |Bandwidth, unit: Mbps, value range [1,10240]|
|**extraUplinkBandwidth**|Integer|False| |Additional Uplink Bandwidth, unit: Mbps, value range [0,10240]|
