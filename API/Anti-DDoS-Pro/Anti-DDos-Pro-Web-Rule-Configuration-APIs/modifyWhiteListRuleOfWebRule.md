...
## Description
Modify whitelist rules of web service rules
...
|Name|Type|Required or Not|Default Value|Description|
|---|---|---|---|---|
|**webWhiteListRuleSpec**|WebWhiteListRuleSpec|True| |Modify request parameters of whitelist rules of web service rules|
