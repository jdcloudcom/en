...
|Name|Type|Description|
|---|---|---|
|**code**|Integer|0: Enabling CC observer mode failed, 1: Enabling CC observer mode succeeded|
|**message**|String|Specify reasons when enabling CC observer mode failed|
