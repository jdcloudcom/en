...
## Description
Search Region Group Statistics Data
...
|**locationName**|String|False| |[Region](../Reference/Region.md), such as Beijing and Shanghai. Separated by commas when there are multiple pieces<br>|
...
|**playerCount**|Long|Number of Persons Online<br>|
