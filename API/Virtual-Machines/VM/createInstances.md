...
|**instanceSpec**|[InstanceSpec](##InstanceSpec)|True||Describe VM instance type<br>|
...
|**charge**|[ChargeSpec](##ChargeSpec)|False||Billing configuration<br>The VM does not support paying by consumption. The default is to pay by configuration.<br>In the case of packaging a data disk, the billing method of the data disk can only be consistent with the VM.<br>In the case of packaging EIP, if the public IP is not specified to be paid by consumption, the IP billing mode of the public network can only be consistent with the VM.<br>|
|**dataDisks**|[InstanceDiskAttachmentSpec[]](##InstanceDiskAttachmentSpec)|False||The instance type information of the data disk. The VM of local disk as the system disk can attach 8 data disks, and the VM of the cloud disk service as the system disk can attach 7 data disks.|
...
|**elasticIp**|[ElasticIpSpec](##ElasticIpSpec)|False||EIP specification associated with the primary IP of the primary network interface|
...
|**primaryNetworkInterface**|[InstanceNetworkInterfaceAttachmentSpec](##InstanceNetworkInterfaceAttachmentSpec)|False||Primary network interface instance type information|
|**systemDisk**|[InstanceDiskAttachmentSpec](##InstanceDiskAttachmentSpec)|False||System disk instance type information|
...
|**networkInterface**|[NetworkInterfaceSpec](##NetworkInterfaceSpec)|False||Network interface API instance type|
