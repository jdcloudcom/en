...
If you have any questions, please contact online customer service, or call 400-615-1212
You can also access Help Center

### Help Center
Getting Started Lesson 1: Select a model and purchase Virtual Machine 
Getting Started Lesson 2: Connect and log in Virtual Machine 
Getting Started Lesson 3: Create and manage Cloud Database
Getting Started Lesson 4: Set up WordPress blog
Go to JD Cloud Lesson, view more tutorials
...
It is suitable for use when technical support is required
...
Find 1,148 relevant results for you
All Documents
Help Center
Please enter the keywords to search, such as Virtual Machine
Search
...
JD Cloud, big data, cloud computing, cloud storage, Virtual Machine, cloud server, website ICP Filing
...
Open Beta Test Application-JD Cloud
...
Journey of Cloud Painting Innovation-JD Cloud
...
JD Cloud makes efforts for 18 months, and steps into the first rank of cloud computing in China
Hosted Cloud Solutions-JD Cloud
Logistics Cloud Solutions-JD Cloud
Safety Solutions-JD Cloud
Logistics Cloud Solutions-JD Cloud
...
Points Mall Solutions- JD Cloud
Unbounded Retail E-commerce Solutions-JD Cloud
Boundless Retail Cloud Technology Platform-JD Cloud
...
-------
Based on JD’s multiple years of technical accumulations in cloud calculation, big data and IOT, JD Cloud provides users and individual website heads with diversified steady, safe and convenient solutions and forecast the infinite possibilities.
...
Exclusive Discount for Enterprise
Exclusive Discount for New Product
Report shows, JD Cloud shows a rapid growth trend in cloud computing market. Forrester has made professional appraisal on JD Cloud in terms of product capability, strategic layout, market performance and so forth; it is worth mentioning that, in terms of strategic layout, JD Cloud has got almost full mark, besides, it is also excellent in product capability and market performance.
...
```
 titleMap: {
          ...
          monitering: {
            ...
            description:
              "Monitoring is a monitoring and alarming service for your JD Cloud resources. It is your monitoring solution expert. It monitors and alarms automatically 24 hours, monitors your cloud service in real time, and you can customize metric monitoring rules and alarming policies. Monitoring will send alarm notifications via SMS, email, etc., and it also provides a view of the current alarm status and alarm history."
          },
          subusers: {
