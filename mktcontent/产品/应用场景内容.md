[
	...
	{
		"instruction":" JCS for Elasticsearch can collect unstructured, semi-structured and structured log information. It loads the capture and preprocessing log data into JCS for Elasticsearch, and combines with Kibana for full-text search, statistics & analysis and multi-dimensional chart display, so as to get valuable information about users and applications.\n Real-time retrieval: Data can be retrieved in seconds to minutes. \n Kibana Visual analysis: it provides a multi-dimensional chart display of data. \n",
		"name":" Log Analysis",
		"description":"[{\"TitleUrl\":\"\",\"TitleName\":\"\"}]",
		"id":"291"
	},
	{
		"instruction":" Application/site search provides an efficient way for users to obtain key information. Users can complete the quick retrieval of full-text contents of e-commerce products and mobile applications, etc.. It supports the creation of advanced search and screening conditions; classifies and counts the eligible products at the same time; highlights the contents being searched; and provides near real-time indexing and accurate positioning from data loading to the completion of retrieval.\n Real-time retrieval: Full text or object information can be retrieved in seconds to minutes after being updated.\nCategory statistics: Collect statistics of eligible objects based on category while performing retrieval.\n",
		"name":" Application/Site Search",
		"description":"[{\"TitleUrl\":\"\",\"TitleName\":\"\"}]",
		"id":"292"
	},
	{
		"instruction":"  JCS for Elasticsearch cluster’s built-in Kibana plug-in supports visual display of data and complex filtering & aggregation statistics function; helps customers to monitor indicators and raise the alarm via JD Cloud Monitoring; and locate the geographic problem areas using JCS for Elasticsearch's geospatial analysis function to determine the root cause and solve the problem." ,
		"name":"Intelligent Monitoring",
		"description":"[{\"TitleUrl\":\"\",\"TitleName\":\"\"}]",
		"id":"293"
	},
