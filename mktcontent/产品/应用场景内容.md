[
	...
	{
        "instruction": "Be able to handle work load of super data center and speed up operation of science, analysis, engineering, consumption and enterprise application programs. Involve image processing, computer vision, data mining and energy prospecting. Perfect high performance, high stability and high accuracy. \n JD Cloud provides the exclusive GPU-Cloud Physical Server, adopts the innovative P40 and V100 of NVIDIA Pascal architecture. At the same time, high CPU and large memory capacity are configured; several high read-write SSD hard disks can meet high IO demands; the high-security and rapid 10-gigabit level Intranet is isolated purely from the physical way; and the network architecture and clusters are flexible...",
        "name": "High-performance Computing",
		"description":"[]",
		"id":"192"
	},
	{
        "instruction": "Meet requirements for processing data of explosive growing trend due to super throughput, and increase processing speed of reasoning work load in any transversely-expanded server. Speed up the deep learning of applications on a large scale, provide excellent user experiences, meet demands for deep learning and periodic training of mass data of the key users, well train more and more complicated models in a short time, improve working efficiency of data scientists and shorten the training time for deep learning from a couple of years to a couple of days.\n JD Cloud provides the unique GPU-Cloud Physical Server and adopts P40 and V100 of the innovative NVIDIA Pascal architecture.  Meanwhile, the configuration...",
	...
	{
		"instruction":"The users submit the image to the container registry, create docker image and conduct management. Pull the image from the container registry through the native container and JCS for Kubernetes to conduct relevant application deployment." ,
		"name":"Continuous Deployment of Containerized Applications",
		"description":"[{\"TitleUrl\":\"https://www.jdcloud.com/products/dockers\",\"TitleName\":\"Native Container\"},{\"TitleUrl\":\"https://www.jdcloud.com/products/JCS for Kubernetes\",\"TitleName\":\"Kubernetes Service\"}]",
		"id":"280"
	},
	{
		"description":"[{\"TitleUrl\":\"\",\"TitleName\":\"\"}]",
