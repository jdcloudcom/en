[
	...
	},
	{
		...
		"banner_description":"The Monitoring can monitor the users' JD Cloud resources and raising alarms, monitor and display various indicators and raise alarm over the monitoring indicators. It will send alarm notifications via SMS, E-mail, etc, and provide users with current alarm status and alarm history. The monitoring service helps customers master the resource usage status, performance and operation on JD Cloud; and the alarm service enable customers to make timely response for stable operation of the application.",
	...
	},
	{
		...
		"banner_description":"Efficient computing service based on GPU is applicable to Artificial Intelligence (AI), image processing and multiple other scenarios. \n Real-time speed provides excellent parallel and floating-point computing power, which can build heterogeneous computing applications.",
	...
	},
	{
		...
		"banner_description":"Auto Scaling is a service that automatically adjusts the scaling of resources based on the service requirements and scaling policy. By setting scheduled task and monitoring alarm policy, users can have adequate resources to ensure stable and sound business operation. During service peak, the VM instances will be increased automatically to ensure the service performance is not affected; for less service demands, the VM instance types will be decreased to save cost. The service is for free, but the resources needed are charged accordingly.",
	...
	},
	{
		...
		"banner_description":"Situation Awareness System is a big data security analysis product of JD Cloud. Through data modeling, behavioral learning, and intelligence correlation analysis, it fully understands the security panorama, discovers intrusions and attack threats to help customers build security monitoring and defense systems. It makes fast and automated correlation analysis of multi-dimensional massive security and business data to display the threats and exception overall security situations through graphic and visual technologies. \n",
	...
	},
	{
		...
		"label":"[{\"TitleName\":\"Try Now\",\"TitleUrl\":\"https://docs.jdcloud.com/cn/live-video/service-provisioning?isWX=\"}]",
	...
	},
	{
		...
		"banner_description":"JD Cloud NF1 ADC series products integrate with GTC global traffic scheduling, network load balancer, application load balancer, O&M management and data monitoring, JD Cloud business quality detection and other products. Combined with WAF, Anti-DDoS Pro local, Advanced Anti-DDoS linkage, traffic cleaning and other security characteristics. Provide users with delivery method combining with private and cloud services to help enterprises to build user access system with security, stability and high performance.",
	...
	},
	{
		...
		"label":"[{\"TitleName\":\"Try Now\",\"TitleUrl\":\"https://docs.jdcloud.com/cn/tidb-service/public-beta-introduction\"}]",
	...
	},
	{
		...
		"banner_description":"JCS for Kubernetes service provides users with easy-to-use, highly reliable and powerful container-managed services with fully hosted management nodes. It is fully compatible with Kubernetes API standards, integrates with JD Cloud network, storage and other plug-ins, simplifies the deployment and management of Kubernetes, lowers the threshold for Kubernetes, enhances the application reliability and development efficiency, and reduces the resources input cost. \n</br> The service is free, with resources use charged: Such as Virtual Machines.",
	...
	},
	{
		...
		"label":"[{\"TitleName\":\"Try Now\",\"TitleUrl\":\"http://code.jdcloud.com\"}]",
		"banner_description":"With the CodeCommit tool based on Git, a user can host a code to JD Cloud. The product package includes code commitment, storage, download, fork management, comparison, merger, history and other functions, which provide source CodeCommit service for the whole process of JD Cloud continuous delivery.",
	...
	},
	{
		...
		"label":"[{\"TitleName\":\"Apply for Trail\",\"TitleUrl\":\"https://www.jdcloud.com/public/testApply/antipro\"},{\"TitleName\":\"Trial Description\",\"TitleUrl\":\"https://docs.jdcloud.com/cn/anti-ddos-protection-package/trial-description\"}]",
		"banner_description":"Anti-DDoS Protection Package is a product that improves Anti-DDoS attack capability for users who deploy businesses in JD Cloud. It has the features that the configuration is simple, EIP is free from switching, the protection capability comes into force upon purchase, and the protection target can be flexibly replaced. It supports smooth upgrade of Anti-DDoS capacity for multiple businesses in JD Cloud, such as the Virtual Machine, the Load Balancer, the Cloud Physical Server, the Web Application Firewall and other services with EIP, effectively guaranteeing network security of business.",
	...
	},
	{
		...
		"banner_description":"JD WorkSpaces is a secure and convenient cloud-based virtual Windows desktop service provided by JD Cloud. Users can access the office environment anytime and anywhere without purchasing, deploying, operating and maintaining physical infrastructure. JD WorkSpaces provides users with superior experience by creating a safer and more convenient IT office system boosting high performance, low cost, and high efficiency." ,
		"advantage_key":"Product_Advantage_101",
		"fundesc_key":"Product_Fundesc_101"
	},
	{
		"instruction":"[{\"explain\":\"Help Center-Introduction\",\"explainLink\":\"https://docs.jdcloud.com/cn/cloud-physical-server/product-overview?isWX=\"},{\"explain\":\"Help Center-Operation Guide\",\"explainLink\":\"https://docs.jdcloud.com/cn/cloud-physical-server/terms-and-conditions?isWX=\"},{\"explain\":\"Help Center-Best Practices\",\"explainLink\":\"https://docs.jdcloud.com/cn/cloud-physical-server/create-and-configure-cloud-physical-server\"}]",
		"id":"1121",
	...
	},
	{
		...
		"label":"[{\"TitleName\":\"Try Now\",\"TitleUrl\":\"https://www.jdcloud.com/public/testApply/memcached\"}]",
	...
	{
		"id":"1137",
		"banner_name":"Directory Service",
		"banner_description":"JCS directory service is a kind of Microsoft Active Directory hosted on JD Cloud, which integrates most functions of directory service with JD Cloud. No matter enterprises use directory service separately in JD Cloud, or expand current directory basic architecture into JD Cloud through the trust relationships of directory service, the end users of them can access resources and applications in the JD Cloud through JD Cloud directory service.",
		"advantage_key":"Product_Advantage_1137",
		"fundesc_key":"Product_Fundesc_1137"
	},
	{
		"id":"1143",
		"banner_name":"PLUS Smart SMS",
		"label":"[{\"TitleName\":\"Buy Now\",\"TitleUrl\":\"https://market.jdcloud.com/#/service/details/577109\"},{\"TitleName\":\"Help Center\",\"TitleUrl\":\"https://docs.jdcloud.com/cn/marketplace/plus-smart-sms-document\"}]",
		"banner_description":"JD Cloud PLUS Smart SMS is an open communication service platform provided by JD Cloud to the user. It supports SMS verification code, SMS notification and marketing & promotion SMS. Based on traditional SMS, add the value to text messages through personalized functional menu configuration, connect traditional SP SMS business and intelligent menu so as to provide the customer with one-stop service for SMS sending and promotion of SMS transformation.",
	...
	},
	{
		...
		"banner_description":"Modular and combinable Private Cloud, providing Turn-Key type one-stop delivery",
	...
	},
	{
		"id":"1152",
		"banner_name":"VOD",
		"label":"[{\"TitleName\":\"Instant Account Setup\",\"TitleUrl\":\"\"}]",
		"banner_description":"Based on strong infrastructure services, JD Cloud develops the One-stop VOD service integrating video uploading, media and information management, transcoding, distribution and playing, and other functions, which can satisfy the need of the whole process of business scenes in various vertical industries such as e-commerce, education, pan entertainment, and video websites.",
		"advantage_key":"Product_Advantage_1152",
		"fundesc_key":"Product_Fundesc_1152"
	},
	{
		"id":"1156",
		"banner_name":"CodePipeline",
		"advantage_key":"Product_Advantage_1156",
		"fundesc_key":"Product_Fundesc_1156"
	}
]
