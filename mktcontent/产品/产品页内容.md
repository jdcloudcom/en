[
	...
	},
	{
		...
		"label":"[{\"TitleName\":\"Help Center\",\"TitleUrl\":\"https://docs.jdcloud.com/cn/marketplace/plus-smart-sms-document\"},{\"TitleName\":\"Buy Now\",\"TitleUrl\":\"\"}]",
		"banner_description":"Marketplace SMS Platform is an open communication service platform provided by JD Cloud to the user. It supports SMS verification code, SMS notification and marketing & promotion SMS. Based on traditional SMS, add the value to text messages through personalized functional menu configuration, connect traditional SP SMS business and intelligent menu so as to provide the customer with one-stop service for SMS sending and promotion of SMS transformation.",
