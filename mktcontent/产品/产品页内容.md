[
	...
	},
	{
		...
		"banner_description":"Object Storage Service (OSS) is a large-scale distributed object storage service independently developed by JD Cloud, which provides cloud storage services of high availability, low cost and strong security for enterprises and individual developers. With unified data management, a variety of storage demands can be satisfied. It supports standard RESTful API, and is charged only by the actual usage without minimum usage limit.",
