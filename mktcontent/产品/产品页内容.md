[
	...
	},
	{
		...
		"banner_description":"JCS for Elasticsearch is an open-source distributed searching and data analysis engine, which is 100% compatible with ELK architecture, and works on scenarios such as data analysis, searching and APP monitoring. One can quickly create and configure Elasticsearch cluster through JD Cloud console in order to implement the fully-hosted service of real-time analysis and search, monitoring and warning." ,
