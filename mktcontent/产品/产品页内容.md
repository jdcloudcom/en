[
	...
	},
	{
		...
		"banner_description":"JD Cloud Data Visualization Screen is a data visualization tool based on real-time multi-layer rendering technology that can provide real-time scenario display of mass data. \n JD Data Visualization Screen is also a graphical development tool for data visualization screen. Non-professional data engineers can perform WYSIWYG visual processing on data to build a data visualization screen by dragging and dropping. At the same time, the Data Visualization Screen provides professional templates that can be applied in multiple industries covering e-commerce sales, agriculture, medical services, government affairs, which greatly meets the display needs of various businesses such as conference and exhibition, workload monitoring, risk warning, and geographic information analysis.",
