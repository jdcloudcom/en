...
| Count of clients that can be attached to each file storage     | No more than 1,000 (If the max. count is exceeded, the stable throughout bandwidth for each client cannot be guaranteed)          |
