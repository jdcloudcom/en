...
Service Status Change includes Run/Stop/Delete (changeDomainStatus/{status})
...
Start domain: https://opencdn.jcloud.com/api/changeDomainStatus/start

Stop domain: https://opencdn.jcloud.com/api/changeDomainStatus/stop

Delete domain: https://opencdn.jcloud.com/api/changeDomainStatus/delete (Note: Domain shall be stopped first before it can be deleted)
