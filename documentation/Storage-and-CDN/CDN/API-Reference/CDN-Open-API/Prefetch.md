...
| publish_urls | List   | Yes           | Support string or String[], separate multiple domain names by the , mark, e.g. ["http://www.a.com/text1.css","http://www.a.com/text2.js"]Up to 100 urls can be prewarmed for a single time |
