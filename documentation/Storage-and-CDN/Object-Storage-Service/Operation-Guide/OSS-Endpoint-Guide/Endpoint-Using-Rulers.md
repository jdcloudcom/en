...
-   You can also replace the OSS Internet access domain to your own domain through [Set Customized Domain](https://docs.jdcloud.com/cn/object-storage-service/set-custom-domain-name-2).
...
**Description: ** For details of OSS cost, please refer to [OSS Price Overview](https://docs.jdcloud.com/cn/object-storage-service/price-overview).
