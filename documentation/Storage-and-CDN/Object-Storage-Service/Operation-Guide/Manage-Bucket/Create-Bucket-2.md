...
1.Log in the JD Cloud console, select Object Storage Service -> bucket Management to log in the space management page and click the button **Create a new bucket**.

2. Click **Create Bucket** and then the following popup shows:
