...
|x-amz-credential|String|If S3 API is used, then the format is \<your-access-key-id\>/\<date\>/\<region\>/s3/aws4_request. Example:AKIAIOSFODNN7EXAMPLEYYYYYYYYYYYY/20180601/cn-north-1/s3/aws4_request<br>Default Value: None|Required for requests requiring signatures|
