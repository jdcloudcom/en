# Performance Test Service Terms
**These Service Terms are the effective contract concluded by and between the integrated service providers under JD Group (hereinafter referred to as "JD Cloud") and you as for performance test service. You accept these Service Terms by sealing, clicking the web page to confirm on the web page or other means, including but not limited to actually using the JD Cloud Performance Test Service without clicking to confirm, indicating that you have reached an agreement with JD Cloud and agreed to accept all agreed contents of these Service Terms. If the text sealed by the Parties is inconsistent with the Service Terms confirmed on the web page or clicked to be accepted otherwise, the text sealed by the Parties shall prevail.**
...
## 1. Service Content
1.1 For the purposes of these Terms, the "service" means: JD Cloud provides you with the Performance Test Service as well as related technologies and network support services as displayed on the website www.jdcloud.com.
...
2.2 You are using Pay-As-You-Go. Please see the page announcement on www.jdcloud.com for the specific deduction rules, which is subject to the current effective billing mode and standard for Pay-As-You-Go issued on the page.
...
3.1.3.5 Do not use the resources and services provided by JD Cloud Performance Test Service to upload, download, store and release the following information or contents, and do not provide any convenience for others to publish such information (including but not limited to setting URLs, Banner links, etc.):
...
3.1.11 Data backup is your obligation and responsibility. JD Cloud Performance Test Service does not provide the data backup function, and users need to process the data backup by themselves. JD Cloud does not assume any responsibility for user data backup work or consequences.**
...
3.2.3 JD Cloud is only responsible for the operation and maintenance of the software provided by JD Cloud, that is, the related technical architecture and operating system of Performance Test Service; other parts except for Performance Test Service shall be your own responsibility.

3.2.4 JD Cloud will eliminate the faults caused by non-man made operations, except for due to your account and/or force majeure and matters out of the control scope of JD Cloud.
...
7.3.4 JD Cloud may notify you in advance of terminating these Service Terms by announcing on www.jdcloud.com 30 days in advance, sending you intra-website notices or giving notices in written form, and at that time, JD Cloud shall refund the amount you have paid but not consumed to your JD Cloud account.
...
8.2.3 As for all or part of the functions of Performance Test Service provided by JD Cloud to you free of charge, any service unavailability, error, vulnerability, etc. emerging and existing in these functions won’t be deemed as default of JD Cloud, and JD Cloud won’t bear any responsibilities for the work or result of your using the free-of-charge functions of Test Performance Service, under the circumstance that JD Cloud hasn’t acted improperly purposefully or hasn’t made major behavioral faults.
...
11.2 JD Cloud shall transfer all or part of the rights and obligations of these Service Terms to the affiliated company of JD Cloud by posting it on www.jdcloud.com 30 days in advance or by sending you notice or written notice on the website.
