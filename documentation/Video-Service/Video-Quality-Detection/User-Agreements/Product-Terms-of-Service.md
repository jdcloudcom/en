# Service Terms of Video Quality Detection

These Service Terms are the effective contracts concluded by and between the owner of the JD Cloud website (referred to as "JD Cloud" in the Agreement, website: www.jdcloud.com) and you in connection with the matters related to the Video Quality Detection Service. You accept these Service Terms by sealing, clicking the web page to confirm on the web page or other methods, including but not limited to actually using the JD Cloud Video Quality Detection Service without clicking to confirm, indicating that you have reached an agreement with JD Cloud and agree to accept all agreed contents of these Service Terms. If the text sealed by the Parties is inconsistent with the Service Terms confirmed on the web page or clicked to be accepted otherwise, the text sealed by the Parties shall prevail.
...
1.1. "Service" in these Terms means: JD Cloud provides you with the Video Quality Detection Service and related technical and network support services displayed on www.jdcloud.com.
...
3.2.3 In case the service involves the Video Quality Detection, JD Cloud is only responsible for the underlayer part under the operating system and the operation maintenance of the software provided by JD Cloud, namely technical architectures, operating systems and others related to services of the Video Quality Detection Service. The part above the operating system (such as the application program you install on your system) is your own responsibility. In addition, if you upgrade the operating system on your own, system breakdown and other adverse effects may be caused; please take care of the risks and be careful to operate.
...
7.1.	 Term of service is calculated from the date you create any Video Quality Detection Service (the service shown to you on jdcloud.com) successfully. The specific term of service will be calculated as per your actual usage.
...
7.3.4 JD Cloud may terminate these Service Terms by advance announcement on www.jdcloud.com or sending you a private notice or a written notice on the website. At that time, JD Cloud shall refund the amount you have paid but not consumed to your JD Cloud account.
