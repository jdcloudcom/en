...
* **Audio Call**  
In case of live video, your favorite local music can be set to be played during the live video, and music files can be gotten from the local iOS media repository. APIs called by audios are as follows:  
```
