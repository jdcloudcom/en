...
7. Select instance template. A drop down box will show a list of satisfied instance templates. Please be sure to select the Generation II Specification of Virtual Machines or Instance Templates of GPU specification. Please choose herein the “Instance Template of Web service” created in the previous step.
