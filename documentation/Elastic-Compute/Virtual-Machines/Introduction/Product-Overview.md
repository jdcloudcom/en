...
* You can use load balancer to automatically distribute business traffic to multiple backend instances. Please refer to [Application Load Balancer Product Documentation](https://docs.jdcloud.com/cn/distributed-network-load-balancer/product-overview) for details.
