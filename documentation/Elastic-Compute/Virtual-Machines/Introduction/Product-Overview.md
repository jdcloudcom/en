# Product Overview
The Virtual Machines are a basic computing service unit provided by JD Cloud & AI, which provides computing services with flexible processing capabilities. It involves a variety of concepts, as shown in the figure below, including instance type (vCPU and memory), operating system, disk, network, security, etc. Each resource provides a variety of configuration options, you can choose as needed.
![](../../../../image/vm/Product-Introduction-Overview.png)
Management of Virtual Machines is simpler and more efficient than that of the physical servers, and you can flexibly combine these resources according to actual needs. Besides, you can create a specified number of Virtual Machines at any time through the console, OpenAPI or CLI. During using, it is available to adjust the instance types based on the business scale as well as to release the excess or idle resources to save input costs. JD Cloud & AI Virtual Machines provide you with a stable and reliable foundation to realize rapid deployment of applications and enable you to focus on core business innovation.

## Related Concepts
See [Core Concepts](Core-Concepts.md) for the concepts that are commonly referred to when learning about JD Cloud & AI Virtual Machines.
## Related Services
...
* You can use load balancer to automatically distribute business traffic to multiple backend instances. Please refer to [Application Load Balancer Product Documentation](https://docs.jdcloud.com/en/distributed-network-load-balancer/product-overview) for details.
...
* You can use the Virtual Machines to set up a database service, or you can use the JD Cloud & AI database service. Please refer to [Cloud Database](../../../Database-and-Cache-Service/RDS/Introduction/Product-Overview.md) for details.
* You can write code to call JD Cloud & AI OpenAPI service to access its products and services. Please refer to [OpenAPI](https://docs.jdcloud.com/virtual-machines/api/overview) for details.

## Using Virtual Machines
JD Cloud & AI provides a Web operation interface - the console. You can use your JD Cloud & AI account to directly login [Virtual Machines Console](https://cns-console.jdcloud.com/compute/list) to manage and operate your Virtual Machines.

JD Cloud & AI also provides APIs for you to manage the VM. For specific information related to API operation of VM. Please refer to [OpenAPI Documentation](https://docs.jdcloud.com/en/virtual-machines/api/overview). You can use SDK (support Java/Python/Go/Node.js/PHP/.Net/C++) to program or use the JD Cloud & AI command line tool (CLI) to call the virtual machine API. For details, please refer to: [SDK Documentation](https://docs.jdcloud.com?act=3) and [CLI Documentation](https://docs.jdcloud.com/en/cli/introduction).
