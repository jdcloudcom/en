# Windows Firewall Allows/ Forbids Port Access
...
4. Select **Port**, Specific Local Port, and fill in the port number that you want to allow/ forbid.
...
5. Select the policy of allowing or forbidding connection, and click **Next** by default.
