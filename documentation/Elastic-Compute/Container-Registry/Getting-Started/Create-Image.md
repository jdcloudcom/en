...
**I. Creation of Registry**
 ...
 1. Turn on the console, log in [Elastic Compute-Container Registry-Registry](https://cns-console.jdcloud.com/host/containerregistry/list), and click **Create**.
    ![](https://github.com/jdcloudcom/en/blob/translationUse/image/Elastic-Compute/Container-Registry/创建注册表页面-EN.png)  
...
**II. Creation of Repository**
 ...
 ![](https://github.com/jdcloudcom/en/blob/translationUse/image/Elastic-Compute/Container-Registry/新建镜像仓库-EN.png)  
 2. Select a region from cn-north-1, cn-east-2 and cn-south-1.  
 3. Select registry  
...
**III. Get Token**
 ...
 ![](https://github.com/jdcloudcom/en/blob/translationUse/image/Elastic-Compute/Container-Registry/获取临时令牌-EN.png)   
...
![](https://github.com/jdcloudcom/en/blob/translationUse/image/Elastic-Compute/Container-Registry/下载临时令牌-EN.png)  
