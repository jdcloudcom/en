...
1.2 The Privacy Right Policy is not applicable to services provided to you by other third parties through the JD Cloud & AI website. For example, when the service provider on JD Cloud & AI Marketplace provides you services relying on Cloud Marketplace, the information you provide to the service provider does not apply to the Privacy Policy.
...
Basic information: in order to complete the registration, management and real-name verification of JD Cloud & AI account, the real, legal and valid personal name, contact address, contact phone number and email address you submitted;

Personal identity information: when you use services such as JD Cloud & AI domain registration, website ICP filing, Cloud Marketplace, ID card, military certificate, Mainland Travel Permit for Hong Kong and Macao Residents, Mainland Travel Permit for Taiwan Residents and so on you submitted;

Network identity identifier information: including system account, password, IP address, email address;

Personal property information: your transaction and purchase records in JD Cloud & AI, as well as virtual property information such as coupons;

Personal Internet surfing records: website browsing records, software use records, log information;

Personal common device information: comprises hardware model, operating system type and basic condition description of personal common device (including IDFA);
...
**1. Without providing the mobile phone number, it is unable to register the account; and it is unable to perform part of operations that the mobile phone verification code is required to confirm the user’s identity, such as retrieving the password.**
...
**4.1.1 When you create a JD Cloud & AI account on JD Cloud & AI website, through the mobile phone number in the People’s Republic of China that you voluntarily submitted, as well as the account number you set up.**

**4.1.2 After you complete registration of JD Cloud & AI account, you can continue to fill in your information in the "Basic information" column of the account, including (1) your membership type (individual, enterprise), company name (if you have completed real-name verification, the company name will be subject to your real-name verification information), main business, (2) contact information (region and street where you locate). Failure in providing such information will not affect your use of a certain service. The (1) type information you provide in this article will help us better understand your requirements for JD Cloud & AI services, so that JD Cloud & AI can promote and introduce products to you specifically; as for the (2) type information you provide in this article, JD Cloud & AI may use the above methods to promote and publicize products to you, send business notifications (including bills) or conduct business communication with you.**

**4.1.3 When a sub-account is created under your account, please collect name, mobile phone number and email of the sub-account subject. Personal information about your sub-account submitted will be deemed as that you have obtained the sub-account subject authorization and submitted the above information of sub-account.**

**4.1.4 After you complete registration of JD Cloud & AI account, you can submit contact information in the Management Console of the account, including the email address and mobile phone number of the contact you specify. JD Cloud & AI will send business notices or have business communication with you via the above information.**

**4.1.5 If you only need to use basic services such as browsing and searching, you do not need to register as our member and provide the above information.**

**4.1.6 If you have registered a JD account, you can log in JD Cloud & AI website with said account. If you log in JD Cloud & AI website with JD account, the real-name registration information (name/company name, ID card number/business license number, mobile phone number/email address) of your JD registered account will be synchronized to JD Cloud & AI.**

**4.2 Your Use of JD Cloud & AI Services**

**4.2.1 When you use JD Cloud & AI services, you shall provide your real identity information through your account to complete real-name verification. During such process, you will provide your name (company principal name), ID card number (business license number), enterprise registration region, enterprise nature, enterprise name and business license registration number, enterprise authorized person information and bank account information (including bank of deposit, bank account number).**

**4.2.2 Before accepting services such as domain, ICP filing, JD Cloud & AI will display the information you need to submit to you through the page of JD Cloud & AI website according to the laws of the People’s Republic of China, which shall be subject to the website page display at that time; if you do not use some services, you do not need to provide relevant information.**

**4.2.3 After you use our service, we will also send a contract and/or invoice and others to you as required according to the recipient name, contact information and shipping address.**

**4.2.4 We will receive and record relevant information (such as device model, operating system version, device settings and other hardware and software characteristic information) of the device you use according to the specific permission you grant in the software installation and use, and relevant information of the device location (such as IP address). We might associate the first two types of information so that we can provide you with consistent services on different devices.**

**4.2.5 When you use the service provided by our website or client, we will automatically collect your detailed usage of our services and save it as the relevant network log. For example, your search & query content, IP address, type of browser, telecom operator, language used, date and time of access and the record of web pages you access, etc.**

**4.2.6 Please note that separate device information, log information, etc., are information that cannot identify the identity of a specific natural person. If we combine such information with other information to identify the identity of a specific natural person or use it in conjunction with personal information, such information will be treated as personal information during the combined use, unless authorized by you or otherwise stipulated by laws and regulations, we will anonymize and de-identify such personal information.**

**4.2.7 Support information for user account: Based on the user consultation records, failure reporting records and troubleshooting process (such as communication or call records) for user failures generated by your use of JD Cloud & AI services, JD Cloud & AI will respond more promptly to your help requests through recording, analyzing such information in order to improve services.**
...
**4.3.3 This privacy statement applies to relevant information recorded through JD Cloud & AI Cookies.**

**4.4 Situations that we obtain your personal information from the third party**

We may obtain your authorized shared account information from a third party, and bind your third-party account with your JD Cloud & AI account after you agree the Privacy Policy, so that you may directly log in and use our products and/or services through the third-party account. **We will use your personal information subject to compliance with relevant laws and regulations after confirming the legality of the source of personal information based on the agreement with the third party.**
...
7.1. You can log in the JD Cloud & AI website or client "Management Console" to search and manage (change, delete) the basic business information (basic information) and contact information submitted when using JD Cloud & AI services.

7.2. If you need to change your real-name verification information in the JD Cloud & AI account, you shall contact JD Cloud & AI by opening ticket or by phone to operate in accordance with JD Cloud & AI's operation document; if you need to change the real-name verification information submitted via JD account, you shall change it on the website on which you register the original account.
...
You can contact JD Cloud & AI by opening ticket or by phone to change such scope of which you authorize us to continue to collect your personal information or withdraw your authorization. You can also withdraw all authorization by which we continue to collect your personal information by canceling the account.
...
7.5 For service maintenance and improvement, we will provide you with information exhibition which suits your personal demands better. We are probable to combine user information from a specific service of JD Cloud & AI website and information of other service, make a characteristic model and provide user profiling, and show and promote information and commercial advertisement probably, including but not limited to news, market activities and promotion information about JD Cloud & AI’s products, promotion information about third parties in cooperation with JD Cloud & AI or other contents you might be interesting. **If you do not prefer to receive commercial electronic information we send to you, you can cancel the information at any time via means below: **
...
10.2 We have set up personal information protection specialists. You are welcome to contact them by sending emails to privacy@jd.com. 
...
You acknowledge and agree that JD Cloud & AI is unable to assist you to recover the aforesaid service. As the account cancellation will bring inconvenience to your after-sales rights protection, please make sure that your account is not involved in any disputes, back up information and data related to the JD Cloud & AI account, download and well keep transaction vouchers, bills (such as the electronic invoice) and other data as for ordered products and services before the cancellation. Otherwise, JD Cloud & AI cannot assist you to get the aforesaid items.

**Instructions for the Cancellation of JD Cloud & AI Account**

Please be sure to carefully go through the *Instructions for the Cancellation of JD Cloud & AI Accoun*t (hereinafter referred to as the *Instructions for Cancellation*), before clicking **OK** when applying for the cancellation process.
...
(5) Authorized login or association relationship with other website and other APPs has been released for the account.
...
3. If your JD Cloud & AI account is the account name associated to other merchants and shops of the JD Cloud & AI platform, you need to release relevant association at first;

4. When the JD Cloud & AI account is canceled, if it is involved in any disputes, including but not limited to complaints, reports, litigations, arbitration and investigations by national authorities, JD Cloud & AI shall be entitled to terminate the cancellation of the JD Cloud & AI account without getting your prior consent.
