...
Updating Date: September 17, 2019
...
1.3 It is required to be specifically stated that, as a user of JD Cloud, if you use the technical services of JD Cloud to provide your user any service, because your business data belongs to you, you should separately agree the corresponding privacy policy with your user.
...
**4.1.1 When you create a JD Cloud account on JD Cloud website, through the mobile phone number in the People’s Republic of China that you voluntarily submitted, as well as the account number you set up.**
...
**4.1.4 After you complete registration of JD Cloud account, you can submit contact information in the Management Console of the account, including the email address and mobile phone number of the contact you specify. JD Cloud will send business notices or have business communication with you via the above information.**
...
7.5 For service maintenance and improvement, we will provide you with information exhibition which suits your personal demands better. We are probable to combine user information from a specific service of JD Cloud website and information of other service, make a characteristic model and provide user profiling, and show and promote information and commercial advertisement probably, including but not limited to news, market activities and promotion information about JD Cloud’s products, promotion information about third parties in cooperation with JD Cloud or other contents you might be interesting. **If you do not prefer to receive commercial electronic information we send to you, you can cancel the information at any time via means below: **
...
[JD Cloud Privacy Policy-PDF Download](https://github.com/jdcloudcom/cn/blob/edit/image/Service-Agreements-and-Guarantees/Platform-Agreement/JDcloud-Privacy-Policy-PDF.pdf)
