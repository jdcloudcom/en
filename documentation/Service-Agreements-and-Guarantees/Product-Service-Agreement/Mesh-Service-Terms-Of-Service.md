**These Service Terms are the effective contracts concluded by and between the owners of the JD Cloud website (referred to as "JD Cloud" in the Agreement, website: [www.jdcloud.com](https://www.jdcloud.com)) and you on the matters related to the Cloud Service Mesh Service. You accept these Service Terms by sealing, clicking to confirm on the web page or other means, including but not limited to actually using the Cloud Service Mesh Service of JD Cloud without clicking to confirm, indicating that you have reached an agreement with JD Cloud and agree to accept all agreed contents of these Service Terms. If the text sealed by the Parties is inconsistent with the Service Terms confirmed on the web page or clicked to be accepted otherwise, the text sealed by the Parties shall prevail.**
...
1.1. For the purpose of these terms, the "service" means: JD Cloud provides you with the Cloud Service Mesh Service as well as related technologies and network support services displayed on the website [www.jdcloud.com](https://www.jdcloud.com).
...
**If you establish and operate multiple websites on the Service Mesh service, you must guarantee that all websites you operate are licensed or approved by the relevant state departments;**
...
3.2.3 In case the service involves the Cloud Service Mesh, JD Cloud is only responsible for the underlayer part under the operating system and the operation maintenance of the software provided by JD Cloud, namely technical architectures, operating systems and others related to services of the Cloud Service Mesh. The part above the operating system (such as the application programs you install on your system) is your own responsibility. In addition, if you upgrade the operating system on your own, system breakdown and other adverse effects may be caused; please take care of the risks and be careful to operate.
...
7.1. The Service Term is calculated from the date when you successfully create any Cloud Service Mesh Service (the service shown and provided for you on jdcloud.com). The specific term of service will be calculated as per your actual usage.
