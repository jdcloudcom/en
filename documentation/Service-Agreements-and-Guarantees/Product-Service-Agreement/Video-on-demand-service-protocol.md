...
**3. Rights and Obligations**
  ...
  3.1.1. You agree to abide by these Service Terms and the relevant management specification and procedures on the service display page. You understand that the contents of the above agreements and specifications may change from time to time. In the event of any changes to the contents of these Service Terms, JD Cloud shall notify you of the modified contents by announcement on the suitable page on [www.jdcloud.com](https://www.jdcloud.com/index) for 30 days in advance. If you disagree with JD Cloud's modification to the related terms in these Service Terms, you have the right to stop using JD Cloud's services. In such case, you need to migrate your business data out and settle the service charge with JD Cloud. If you continue to use JD Cloud Service, you are deemed to accept the modification made by JD Cloud regarding the terms of service.
  ...
  3.1.3.1. If your business activities using the services provided by JD Cloud require the license or approval of the relevant state departments, you shall obtain relevant license or approval. It includes but not limited to the following:
  ...
  *If you are running multiple websites, you must guarantee that all of your websites are licensed or approved by the relevant state departments; if your website provides non-operational Internet information service, you must handle the non-operational website ICP filing formalities, ensure that all the ICP filing information submitted is true and effective, and submit the updated information in the ICP filing system in time when the ICP filing information changes; if your website provides operational Internet information service, you shall also obtain a license for the operational website with the local communication management department; if you operate electronic announcement services such as BBS, you shall conduct ICP filing or obtain corresponding approval according to the requirements of relevant laws and regulations; if you operate an Internet game website, you shall obtain the Permit for Cyber Culture Business Operations; if you operate an Internet audio and/or video website, you shall obtain a License for the Dissemination of Audiovisual Programs according to law; if you are engaged in Internet Content services such as news, publishing, education, medical care, pharmaceuticals and medical devices, it shall be reviewed and approved by relevant competent departments in accordance with laws, administrative regulations and relevant state regulations, and shall be reviewed and approved by relevant competent departments before applying for business license or handling ICP filing formalities You understand and acknowledge that the above list does not exhaust all types of licenses or approvals required by the relevant state departments for your business or non-business activities. You shall obtain relevant licenses or approvals, and shall comply with the requirements of relevant laws and regulations issued by the state and local from time to time.*
  ...
  3.1.3.5. Do not use the resources and service provided by JD Cloud to upload, download, store, and publish the following information or contents, and do not provide any convenience for others to publish such information (including but not limited to setting URL, BANNER links, etc.):
  ...
  *3.1.3.5.8. Other contents that violate laws and regulations, departmental regulations or national policies.*
  ...
  3.1.3.9. Do not use the services provided by JD Cloud to engage in acts that damage the legitimate rights and interests of JD Cloud, JD Cloud's affiliated companies or all the companies and websites within JD Group;
  ...
  3.1.7. You are responsible for the content of data that you store on JD Cloud platform; if the uploaded and stored contents are in violation of laws and regulations, department rules or national policies, you will be responsible for all the consequences. System records of JD Cloud may be used as evidence of your violation of laws and regulations.
  ...
  3.1.10. You understand and acknowledge that in the process of using VOD Service of JD Cloud:
  ...
  *(7) Information that infringes upon the legitimate rights and interests of others and/or other information or contents detrimental to social order, social security and public morals;*
  ...
  3.2.2.1. JD Cloud will provide a 7×24h after-sales fault service for the paying users, and provide effective contact information for the paying users to ensure that the paying users can contact the fault contacts. The fault contacts will send feedback in time after define the fault;

  3.2.2.2. JD Cloud will provide a 7×24h online ticket service system to answer customer questions during the use.

  3.2.3. JD Cloud is only responsible for the underlying part under the operating system and the operation maintenance of the software provided by JD Cloud, namely the related technical architecture and operating system of VOD Service. The part above the operating system (such as the application programs you install on your system) is your own responsibility. In addition, if you upgrade the operating system on your own, system breakdown and other adverse effects may be caused; please take care of the risks and be careful to operate.
...
**4. Saving, Destroying and Downloading of User Data**
  ...
  4.1. JD Cloud may use account registration information submitted by you to provide you with marketing information of products and services; JD Cloud may detect and record your service use behaviors (excluding your business data) to provide you with Yundun Service (if any).
...
**5. Intellectual Property Right**
  ...
  5.3. You acknowledge that the intellectual property rights of any materials, technologies or technical supports, software, or services provided by JD Cloud are owned by JD Cloud or a third party. Except for the express consent of JD Cloud or a third party, you have no right to copy, disseminate, transfer, license or provide others to use the above resources; otherwise you shall bear corresponding responsibilities.
...
**7. Start, Stop and Termination of Service**
  ...
  7.3 JD Cloud will terminate to provide VOD Service for you in the following cases:

  7.3.1. The Parties agree to terminate the service;

  7.3.2. Due to the change of JD Cloud’s operation policy, JD Cloud may terminate the service under these Service Terms by methods of giving an announcement in advance, providing notice in appropriate page in the website or sending an on-site notice or a written notice to you;
  ...
  7.3.5. JD Cloud may terminate the Service Terms by methods of providing an announcement on the page of [www.jdcloud.com](https://www.jdcloud.com/index) or sending you an on-site notice or a written notice to you for 30 days in advance. At that time, JD Cloud shall refund the amount you have paid but not consumed to your JD Cloud account.
...
**8. Liability for Breach of the Agreement**
  ...
  8.3 If you are unable to use the service for 72 consecutive hours due to JD Cloud, you may terminate the service, except for reasons other than those within the control of JD Cloud.
