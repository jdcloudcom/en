**<div align=center>General Commodity Identification Service Terms</div>**

**These Service Terms are the effective contracts concluded by and between Beijing Wodong Tianjun Information Technology Co., Ltd. (hereinafter referred to as "JD Cloud & AI" in the Agreement) and you on the matters related to the General Commodity Identification Service. You select to accept these Service Terms by sealing, clicking to confirm on the web page or other means, including but not limited to actually using JD Cloud & AI’s General Commodity Identification Service without clicking to confirm, indicating that you have reached an agreement with JD Cloud & AI and agreed to accept all agreed contents of these Service Terms. If the text sealed by the Parties is inconsistent with these Service Terms confirmed on the web page or selected to be accepted otherwise, the text sealed by the Parties shall prevail.**
...
1.1. For the purpose of these Terms, the "Service" means: General Commodity Identification Service provided by JD Cloud & AI to you as well as related technologies and network support services as displayed on the website [www.jdcloud.com](https://www.jdcloud.com).

1.2. JD Cloud & AI's General Commodity Identification Service is a service that can identify a commodity in an image or a video and obtain the commodity category and name of an article based on JD's massive commodity data and rich shopping scenarios, and support content analysis and photograph view in a shopping scenario.
...
3.2.3 In case the service involves the General Commodity Identification, JD Cloud & AI is only responsible for the underlayer part under the operating system and the operation and maintenance of the software provided by JD Cloud & AI, namely technical architectures, operating systems and others related to the General Commodity Identification Service. You shall be responsible for the part above the operating system (such as the application programs you install on your system). In addition, if you upgrade the operating system on your own, system breakdown and other adverse effects may be caused; please pay attention to the risk and be careful with the operation.
...
7.1. The term of service is calculated from the date when you successfully create any General Commodity Identification Service [you need to confirm if this service can be created one by one at the business side] (the service shown and provided for you on jcloud.com). The specific term of service will be calculated as per your actual usage.
...
7.3.2. Once any service of General Commodity Identification is disabled [please confirm at the business side that if the services can be provided to the same user at the same time], JD Cloud & AI will stop providing the service of General Commodity Identification; if all services of General Commodity Identification are disabled, these Service Terms shall be terminated;
