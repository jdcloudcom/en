**This Service Terms is a valid agreement between the owner of the JD Cloud & AI website (referred to in this Agreement as "JD Cloud & AI" website: [www.jdcloud.com](https://www.jdcloud.com) ) and you on matters relating to the relational database service cloud database. By stamping, clicking to confirm on the web page, or other ways to accept the Service Terms, including but not limited to the actual use of cloud database of JD Cloud & AI without clicking to confirm the Service Terms, you have reached an agreement with JD Cloud & AI and agreed to accept all agreed contents of the Service Terms. In case of any inconsistency between the text stamped by both parties and the text of Service Terms accepted and confirmed by clicking the web page or other ways, the text stamped by both parties shall prevail.**
...
1.1 "Services" in the Terms means JD Cloud & AI provides you with the cloud database services and related technical and network support services displayed on the website [www.jdcloud.com](https://www.jdcloud.com).
...
3.2.3 Where the service involves cloud database, JD Cloud & AI is responsible only for the operation maintenance at the bottom part of database system and of the software provided by JD Cloud & AI, that is, the related technical architecture and operating system of the cloud database. The application part above the database is your responsibility.
...
7.2.3.1 You can continue to use the cloud database service of JD Cloud & AI for 24h from the first arrears; if, 24h later, you still fail to recharge it successfully and enough to pay the service fees owed, JD Cloud & AI will suspend the service and freeze the operation of the cloud database under your account, but still store your data and continue to bill;
...
7.2.5 JD Cloud & AI may terminate this Service Terms in advance by announcing at www.jdcloud.com or notifying you through website or in writing. At that time, JD Cloud & AI shall refund the amount you have paid but not spent to your JD Cloud & AI account.
