**These Service Terms are the effective contracts concluded by and between the owners of the JD Cloud website (referred to as "JD Cloud" in the Agreement, website: [www.jdcloud.com](https://www.jdcloud.com/index)) and you in connection with the matters related to the Distributed Cloud Physical Server service. You select to accept these Service Terms by sealing, clicking to confirm on the web page or other means, including but not limited to actually using JD Cloud's Distributed Cloud Physical Server service without clicking to confirm, indicating that you have reached an agreement with JD Cloud and agreed to accept all agreements of these Service Terms. If the text sealed by the Parties is inconsistent with the Service Terms confirmed on the web page or clicked to be accepted otherwise, the text sealed by the Parties shall prevail.**

**With regards to these Service Terms, you are reminded to pay extra attention on the terms of limitation and exemption, terms of JD Cloud judging and handling your violation and breach of Terms, and the optional terms of the competent court. Restriction and exemption terms may be bold or underlined to raise your attention. Please read through these Service Terms carefully before accepting these Service Terms. If you have any questions about these Service Terms, please contact the related business department of JD Cloud to state the inquiry, and JD Cloud will interpret the terms to you. If you do not agree with any of these Service Terms, or cannot accurately understand JD Cloud's interpretation of the Terms, please do not conduct follow-up actions.**

**1. Service Content**

1.1 For the purposes of these Terms, the "Service" means: JD Cloud provides you with such Distributed Cloud Physical Server service and related technologies and network support services as displayed on the website [www.jdcloud.com](https://www.jdcloud.com/index).
...
**3.1.3.5** ** Do not disseminate Email advertisements or SPAM: Do not use the services provided by JD Cloud to disseminate a large number of undesirable or unsolicited Emails, electronic advertisements or Emails containing reactionary, pornographic and other harmful information;**

**3.1.3.6** **The Distributed Cloud Physical Server provided by JD Cloud shall not be used as a virtual server, or leased as disk space, or used as an illegal proxy server (proxy) or spam server;**

**3.1.3.7** **Do not use the resources and services provided by JD Cloud to upload, download, store and release the following information or contents, or provide any convenience for others to release such information (including but not limited to setting url, banne links, etc.):**
...
**3.1.3.8** **Do not occupy or cause programs or processes to occupy a large amount of the server memory, CPU or network bandwidth resources on the platform (hereinafter referred to as the "cloud platform") composed by JD Cloud's cloud computing resources (such as Distributed Cloud Physical Server, network bandwidth and bucket), and cause serious and unreasonable load to networks, servers (including but not limited to local, foreign and international networks, servers, etc.) and products/applications of JD Cloud platform or other JD Cloud users, affecting the normal and accessible communications between JD Cloud and the Internet or JD Cloud between specific networks and servers and within JD Cloud, or causing system breakdown or system halted of servers of products and services on JD Cloud platform or other JD Cloud users or users’ failure of access to products/applications based on the cloud platform;**

**3.1.3.9** **You fully understand and authorize JD Cloud to scan and monitor Distributed Cloud Physical Server for security vulnerability and JD Cloud shall not bear any responsibility for any possible adverse effect (including but not limited to occupancy of Distributed Cloud Physical Server resource, network bandwidth usage and service exceptions) that may occur in the scanning process.**

**3.1.3.10** **You are obligated to guarantee that the Distributed Cloud Physical Server shall not be affected by security vulnerabilities; with regard to the notice of vulnerability patch issued by JD Cloud, you shall proactively take repair measures to eliminate the impact; JD Cloud shall not bear any responsibility in case that the Distributed Cloud Physical Server is attacked due to security vulnerability (including but not limited to suffering from intrusions, compromised host and denial of service).**
...
3.2.3 In case that the service involves the Distributed Cloud Physical Server, JD Cloud is only responsible for the underlayer part under the operating system and the operation and maintenance of the software provided by JD Cloud, namely the technical architectures, operating systems and others related to services of the Distributed Cloud Physical Server. The part above the operating system (such as the application program you install on your system) is your own responsibility. In addition, if you upgrade the operating system on your own, system breakdown and other adverse effects may be caused; please take care of the risks and be careful to operate.
...
3.2.6 You understand and accept that JD Cloud will migrate the data center of the Distributed Cloud Physical Server service which you use when necessary. JD Cloud will notify you 7 natural days in advance before the above actions; since the above actions may need to modify DNS of relevant domain of yours, so you need to modify the DNS to the IP specified by JD Cloud according to the time required by JD Cloud upon receipt of the notification from JD Cloud. Otherwise, you are responsible on your own in case the website application cannot be accessed.
...
**7.2.2** **In case that you are in serious breach of these Service Terms (including but not limited to: a. You fail to perform your payment obligation as agreed herein, and/or b. You seriously violate the provisions of laws), JD Cloud has the right to terminate the services in advance without refunding the cost that you have already paid;**

**7.2.3** **You understand and fully accept that although JD Cloud has established, and will continue to improve according to the development of technology, necessary technical measures to protect against the matters or acts harmful to network security (hereinafter collectively referred to as such acts) including computer viruses, network intrusions, attack damages (including but not limited to DDOS and NTP attacks), in consideration of limitations and relativity of such network security technology and unpredictability of such acts, JD Cloud may decide to suspend or terminate the services if you bring any harm to JD Cloud or JD Cloud’s other networks or servers due to encountering such acts, including but not limited to local and foreign and international networks and servers, or affect the accessible communications between JD Cloud and the Internet, or between JD Cloud and specific networks and servers, or within JD Cloud. If the service is terminated, the service charge will be calculated on the basis of the actual month of service (in case of less than one month, it shall be counted as one month) and the remaining amount (if any) will be returned.**

7.2.4 JD Cloud may terminate these Service Terms by advance announcement on [www.jdcloud.com](https://www.jdcloud.com/index), website notice or written notification. At that time, JD Cloud shall refund the amount you have paid but not consumed to your JD Cloud account.
...
**8.2** **You understand that, in consideration of the particularity of computers and the Internet, JD Cloud shall not be deemed as breach of these Terms if under the following circumstances:**

**8.2.1** **JD Cloud need to suspend services for a short time when configuring and maintaining the server;**

**8.2.2** **Your website access speed is degraded due to path congestion on the Internet.**

**8.4** ** JD Cloud shall not be liable for any indirect, consequential, disciplinary, incidental or special damages in any cases, including your loss of profits suffered by using JD Cloud service (even if you have been informed of the possibility of such losses).**
...
11.1 JD Cloud's service description, price description and the ordering Page you confirm on [www.jdcloud.com](https://www.jdcloud.com/index) are an integral part of these Service Terms. If the service description, price description and the order form you agree on the relevant pages at [www.jdcloud.com](https://www.jdcloud.com/index) are inconsistent with these Service Terms, these Service Terms shall prevail.
