**<div align=center>Service Terms of Pedestrian Re-identification</div>**

**These Service Terms are the effective contracts concluded by and between the owners of the Beijing Wodong Tianjun Information Technology Co., Ltd. (hereinafter referred to as "JD Cloud & AI" in the Agreement) and you on the matters related to the service of Pedestrian Re-identification. You select to accept these Service Terms by sealing, clicking to confirm on the web page or other means, including but not limited to actually using JD Cloud & AI’s Pedestrian Re-identification service without clicking to confirm, indicating that you have reached an agreement with JD Cloud & AI and agreed to accept all agreed contents of these Service Terms. If the text sealed by the Parties is inconsistent with these Service Terms confirmed on the web page or selected to be accepted otherwise, the text sealed by the Parties shall prevail.**
...
1.1. For the purpose of these Terms, the "Service" means: Pedestrian Re-identification provided by JD Cloud & AI to you as well as related technologies and network support service as displayed on the website [www.jdcloud.com](https://www.jdcloud.com).

1.2. The service of Pedestrian Re-identification of JD Cloud & AI can be used for detection human bodies in images, extracting features of one pedestrian as per clothing, complexion, height and physical appearance and returning characteristic value of the pedestrian.
...
3.2.3 In case the service involves the Pedestrian Re-identification, JD Cloud & AI is only responsible for the underlayer part under the operating system and the operation maintenance of the software provided by JD Cloud & AI, namely technical architectures, operating systems and others related to service of Pedestrian Re-identification. You shall be responsible for the part above the operating system (such as the application programs you install on your system). In addition, if you upgrade the operating system on your own, system breakdown and other adverse effects may be caused; please pay attention to the risk and be careful with the operation.
...
7.1. The term of service is calculated from the date when you successfully create any service of Pedestrian Re-identification [it is able to confirm that the service can be created at the business side one by one] (the service shown and provided for you on jdcloud.com). The specific term of service will be calculated as per your actual usage.
...
7.3.2. Once any service of Pedestrian Re-identification is disabled [please confirm at the business side that if the services can be provided to the same user at the same time], JD Cloud & AI will stop providing the service of Pedestrian Re-identification; if all services of Pedestrian Re-identification are disabled, these Service Terms shall be terminated;
