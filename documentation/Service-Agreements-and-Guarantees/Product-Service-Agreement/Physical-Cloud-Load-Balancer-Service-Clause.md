**These Service Terms are the effective Contract concluded by and between the owners of the JD Cloud & AI website (referred to as "JD Cloud & AI" website in the Agreement www.jdcloud.com ) and you on the matters related to Physical Cloud Load Balancer Service. You select to accept these Service Terms by sealing, clicking to confirm on the web page or other means, including but not limited to actually using JD Cloud & AI Physical Cloud Load Balancer Service without clicking to confirm on the page, indicating that you have reached an agreement with JD Cloud & AI and agree to accept all agreed contents of these Service Terms. If the text sealed by the Parties is inconsistent with the Service Terms confirmed on the web page or clicked to be accepted otherwise, the text sealed by the Parties shall prevail.**
...
1.1. For the purposes of these Terms, the "service" means: JD Cloud & AI provides you with Physical Cloud Load Balancer Service as well as related technologies and network support services as displayed on the website [www.jdcloud.com](https://www.jdcloud.com/).

1.2. The service provided by JD Cloud & AI must comply with the agreement in these Service Terms.

### 2. Service Charge

2.1. The service charge will be listed and shown on your order page; you shall pay the corresponding service charge according to the price system in force on the website [www.jdcloud.com](https://www.jdcloud.com/).

2.2. You may select Pay-In-Advance or Pay-As-You-Go:

2.2.1. Pay-In-Advance

2.1.1.1. JD Cloud & AI will only start to provide services for you upon your payment.

2.1.1.2. If the Parties are willing to continue cooperation after the expiration of the services, you shall pay the renewal charge within at least 7 days before the expiration of the service, so as to continue the services. If JD Cloud & AI has adjusted the product system, names or prices at the time of renewal, the Parties agree to perform in accordance with the new product system, names or prices that are effective at that time.
...
**If you provide electronic announcement services such as BBS, you shall also implement ICP filing or obtain corresponding approval according to relevant laws and regulations;**
...
**3.1.3.4. Do not disseminate Email advertisements or SPAM: Do not use the services provided by JD Cloud & AI to disseminate a large number of undesirable or unsolicited Emails, electronic advertisements or Emails containing reactionary, pornographic and other harmful information;**
...
**3.1.3.6. Do not occupy or cause programs or processes to occupy a large amount of the server memory, CPU or network bandwidth resources on the platform (hereinafter referred to as the "cloud platform") consisting of cloud computing resources of JD Cloud & AI (such as cloud servers, network bandwidth, bucket, etc.), cause serious load on the networks, servers (including but not limited to local and foreign and international networks, servers, etc.), products/applications, etc. of the users of JD Cloud & AI cloud platform or other users of JD Cloud & AI, affect the smooth communications between JD Cloud & AI and the Internet or between JD Cloud & AI specific and networks and servers and internal smooth communication within JD Cloud & AI, or cause the system breakdown or system halt of the servers that the products and services of JD Cloud & AI cloud platform or other user websites of JD Cloud & AI are on, or failure of access of users to the products/applications based on the cloud platform, etc.;**
...
3.2.3. JD Cloud & AI is only responsible for the underlying part under the operating system and the operation maintenance of the software provided by JD Cloud & AI, namely the related technical architecture and operating system of SLB. The part above the operating system (such as the application programs you install on your system) is your own responsibility. In addition, if you upgrade the operating system on your own, system breakdown and other adverse effects may be caused; please prepare for the risks and be responsible for your careful actions.
...
7.3.2. JD Cloud & AI will stop providing the Physical Cloud Load Balancer Service if you shut down any Physical Cloud Load Balancer; if you shut down all Physical Cloud Load Balancers, these Service Terms will be terminated;

7.3.3. In case that you are in serious breach of these Service Terms (including but not limited to a. you have not performed your payment obligation as agreed and/or b. you have seriously violated the provisions of laws, etc.), JD Cloud & AI has the right to terminate the services in advance, but you still need to pay the remaining service charge; 
...
7.3.5. JD Cloud & AI can terminate these Service Terms by making an announcement on [www.jdcloud.com](https://www.jdcloud.com/) or giving you an on-website or written notice in advance. At that time, JD Cloud & AI shall refund the amount you have paid but not consumed to your JD Cloud & AI account.
...
11.1. JD Cloud & AI's service description, price description on relevant pages of [www.jdcloud.com](https://www.jdcloud.com/) and the order page confirmed and agreed by you are integral of these Service Terms. If the service description, price description and the Ordering Page you agree on the relevant pages at [www.jdcloud.com](https://www.jdcloud.com/) are inconsistent with these Service Terms, these Service Terms shall prevail.

11.2. JD Cloud & AI is entitled to transfer part or all of the rights and obligations under these Service Terms to JD Cloud & AI’s associated companies by making an announcement on [www.jdcloud.com](https://www.jdcloud.com/) or giving you an on-website or written notice in advance.
