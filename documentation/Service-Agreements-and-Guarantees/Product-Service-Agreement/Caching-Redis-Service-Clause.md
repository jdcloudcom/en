**The Service Terms is the valid agreement between the owner of the JD Cloud & AI website (referred to in this Agreement as "JD Cloud & AI" website: [www.jdcloud.com](https://www.jdcloud.com) ) and you on matters relating to JCS for Redis of JD Cloud & AI. By stamping, clicking to confirm on the web page, or other ways to accept the Service Terms, including but not limited to the actual use of JCS for Redis service of JD Cloud & AI without clicking to confirm the Service Terms, you have reached an agreement with JD Cloud & AI and agreed to accept all agreed contents of the Service Terms. In case of any inconsistency between the text stamped by both parties and the text of Service Terms accepted and confirmed by clicking the web page or other ways, the text stamped by both parties shall prevail.**
...
1.1 "Service" in the terms refers to the live JCS for Redis service and related technical and network support services that JD Cloud & AI provides to you at [www.jdcloud.com](https://www.jdcloud.com).
...
2.1.1.1 After you pay, JD Cloud & AI will start to provide service for you.
...
3.1.3.5 The JCS for Redis provided by JD Cloud & AI shall not be used as disk space for rent;
...
3.2.3 JD Cloud & AI is only responsible for the operation and maintenance of the software provided by itself, that is, the relevant technical architecture and operating system for JCS for Redis. You are responsible for the other parts except for JCS for Redis.
...
7.2.3.1 You can continue to use the JCS for Redis service of JD Cloud & AI for 24h from the first arrears; if, 24h later, you still fail to recharge it successfully or the account balance is still not enough to pay the service fees owed, JD Cloud & AI will suspend the service and freeze the operation of the JCS for Redis under your account, but still store your data and continue to bill;
...
7.2.5 JD Cloud & AI may terminate the Service Terms in advance by announcing at [www.jdcloud.com](https://www.jdcloud.com) or notifying you through website or sending you a written notice. At that time, JD Cloud & AI shall refund the amount you have paid but not spent to your JD Cloud & AI account.
