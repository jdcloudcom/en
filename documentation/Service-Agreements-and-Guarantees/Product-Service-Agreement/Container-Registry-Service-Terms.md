**These Service Terms are the effective Contract concluded by and between the owners of the JD Cloud website (referred to as “JD Cloud” in the Agreement (http://www.jdcloud.com)) and you on the matters related to network Container Registry service. You accept these Service Terms by sealing, clicking to confirm on the web page or other means, including but not limited to actually using JD Cloud Container Registry service without clicking to confirm, indicating that you have reached an agreement with JD Cloud and agree to accept all of these Service Terms. If the text sealed by the Parties is inconsistent with the Service Terms confirmed on the web page or clicked to be accepted otherwise, the text sealed by the Parties shall prevail.**
...
1.1.	 “Service” in these Terms means: JD Cloud provides you with the Container Registry service and related technical and network support services displayed on www.jdcloud.com.
...
3.2.3 In case the service involves Container Registry, JD Cloud is only responsible for the underlying part under the operating system and the operation maintenance of the software provided by JD Cloud, namely the related technical architecture and operating system of Container Registry service. The part above the operating system (such as the application program you install on your system) is your own responsibility. In addition, if you upgrade the operating system on your own, system breakdown and other adverse effects may be caused; please take care of the risks and be careful to operate.
...
7.3.2. JD Cloud will stop providing the Container Registry service if you shut down any Container Registry; if you shut down all Container Registries, these Service Terms will be terminated;
