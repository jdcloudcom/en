**These Service Terms are the effective contracts concluded by and between the owners of the JD Cloud & AI website (referred to as "JD Cloud & AI" in the Agreement, website: **[www.jdcloud.com](http://www.jcloud.com/index)**) and you on the matters related to JD Cloud & AI HSM. You accept these Service Terms by sealing, clicking the web page to confirm on the web page or other means, including but not limited to actually using JD Cloud & AI's JD Cloud & AI HSM without clicking to confirm, indicating that you have reached an agreement with JD Cloud & AI and agree to accept all agreed contents of these Service Terms. If the text sealed by the Parties is inconsistent with the Service Terms confirmed on the web page or clicked to be accepted otherwise, the text sealed by the Parties shall prevail.**
...
1.1 For the purposes of these Terms, the "Service" means: JD Cloud & AI provides you with such JD Cloud & AI HSM and related technologies and network support services as displayed on the website [www.jdcloud.com](https://www.jcloud.com/).
...
2.2 JD Cloud & AI HSM instance currently supports Pay-In-Advance and JD Cloud & AI will start to provide you with services upon your payment.

2.3 **If the Parties are willing to continue cooperation after the expiry of JD Cloud & AI HSM instance, you shall pay the renewal charges 30 days prior to the expiry of the Service Term so as to continue the services. If JD Cloud & AI has adjusted the product system, names or prices at the time of renewal, the Parties agree to perform in accordance with the new product system, names or prices that are effective at that time.** 

**2.4** **JD Cloud & AI reserves the right not to provide you with services and/or technical supports or to terminate the services and/or technical supports until you have paid off all the costs as agreed. In the meanwhile, JD Cloud & AI reserves the right to pursue legal liability for arrears in Pay-As-You-Go service.** 
...
**3.1.3.1** **Not to make use of this service to carry on protection selling business such as Web intrusion protection and CC defense;** 

**3.1.3.2** **Not to separately use each part of JD Cloud & AI HSM for any purpose;** 

**3.1.3.3** **Except for the express permission of JD Cloud & AI, the software provided by JD Cloud & AI may not be modified, translated, adapted, leased, sub-licensed, or disseminated or transferred on the information network, nor reversely engineered, decompiled or found the source code of the software provided by JD Cloud & AI in other ways by attempt;** 

**3.1.3.4** **If JD Cloud & AI’s services involve the use license of third-party software, you agree to abide by the relevant license agreement;** 

**3.1.3.5** **Your protection business conducted via JD Cloud & AI HSM must be the normal commercial business, scientific research business and those conforming to provisions of the laws of the state. You shall not use this service for any illegal business, including but not limited:** 

**3.1.3.5.1** **Political propaganda and/or news in violation of state regulations;**

**3.1.3.5.2** **Business concerning state secrets and/or security;** 

**3.1.3.5.3** **Business of feudalistic superstition and/or obscenity and/or abetting commitment of crime;** 

**3.1.3.5.4** **Lottery prizes, gambling games, "private services", "plug-ins" and other illegal Internet publishing activities;** 

**3.1.3.5.5** **Business that violates national ethnic and religious policies;** 

**3.1.3.5.6** **Business that impedes running security of the Internet;** 

**3.1.3.5.7** **Business that infringes upon the legitimate rights and interests of others and/or other activities detrimental to social order, social security and public morals;** 
...
3.2.4 JD Cloud & AI will provide the technical support specified in these Service Terms, but shall not cover any influence and loss caused by your reasons (including but not limited to code quality, human-based management omission, your own security management, etc.). 
...
7.1 You may subscribe JD Cloud & AI HSM for free. If you do not submit a review application for JD Cloud & AI HSM within 30 days from your purchase date, you can ask for a refund. JD Cloud & AI HSM is valid from the date when your review material is approved till the termination conditions stipulated by the laws and regulations or agreed in these Service Terms occur. 
...
7.2.3 JD Cloud & AI will not assume any obligations and responsibilities for the unavailability of user website and service due to expiry or revocation of the user's JD Cloud & AI HSM. 

7.2.4 JD Cloud & AI can terminate these Service Terms by sending out a public notice or giving you an on-website or written notice at [www.jdcloud.com](https://www.jcloud.com/). At that time, JD Cloud & AI shall refund the amount you have paid but not consumed to your JD Cloud & AI account.
...
8.2 If you are unable to use your applied JD Cloud & AI HSM due to causes of JD Cloud & AI, you may terminate the service, except for those caused by reasons outside the control of JD Cloud & AI. 
...
11.1 JD Cloud & AI's service description, price description on relevant pages and the order page confirmed and agreed by you on [www.jdcloud.com](https://www.jcloud.com/) are integral parts of these Service Terms. If the service description, price description and the order page confirmed and agreed by you on [www.jdcloud.com](https://www.jcloud.com/) are inconsistent with these Service Terms, these Service Terms shall prevail.

11.2 JD Cloud & AI is entitled to transfer part or all of the rights and obligations under these Service Terms to JD associated companies by making an announcement on [www.jdcloud.com](https://www.jcloud.com/) or giving you an on-website or written notice to you.
