**These Service Terms are the effective contracts concluded by and between the owners of the JD Cloud website (referred to as "JD Cloud" in the Agreement, website: **[**www.jdcloud.com**](https://www.jdcloud.com/index) **) and you in connection with the matters related to the NAT Gateway service. You select to accept these Service Terms by sealing, clicking to confirm on the web page or other means, including but not limited to actually using JD Cloud's NAT Gateway service without clicking to confirm, indicating that you have reached an agreement with JD Cloud and agreed to accept all agreements of these Service Terms. If the text sealed by the Parties is inconsistent with the Service Terms confirmed on the web page or clicked to be accepted otherwise, the text sealed by the Parties shall prevail.**
...
1.1 For the purposes of these Terms, the "Service" means: JD Cloud provides you with such NAT Gateway service and related technologies and network support services as displayed on the website [www.jdcloud.com](https://www.jdcloud.com/index).
...
2.2 Payment mode: Please view the announcement on [www.jdcloud.com](https://www.jdcloud.com/index) for the specific deduction rules, and the current billing mode and standard published on the page shall prevail.
...
**3.1.3.6. Do not be occupy or cause programs or processes to occupy a large amount of the server memory, CPU or network bandwidth resources on the platform (hereinafter referred to as the "cloud platform") consisting of JD Cloud cloud computing resources (such as cloud servers, network bandwidth and bucket), cause serious load on the networks, servers (including but not limited to local and foreign and international networks, servers, etc.), products/applications, etc. of the users of JD Cloud cloud platform or other users of JD Cloud, affect the smooth communications between JD Cloud and the Internet or between JD Cloud specific and networks and servers and internal smooth communication within JD Cloud, or cause the system breakdown or system halt of the servers that the products and services of JD Cloud cloud platform or other user websites of JD Cloud are on, or failure of access of users to the products/applications based on the cloud platform, etc.;**
...
3.2.3. In case that the service involves the NAT Gateway, JD Cloud is only responsible for the operation and maintenance of the NAT Gateway service and the software provided by JD Cloud, namely the technical architectures and operating systems related to the NAT Gateway.
...
7.1. Service Term You can immediately use JD Cloud's NAT Gateway service from the date when you enable the NAT Gateway service (it refers to the service displayed and provided for you on [www.jdcloud.com](https://www.jdcloud.com/index)). The specific Service Term will be calculated according to your actual use.
...
7.3.2. JD Cloud will stop providing any NAT Gateway service you shut down;
...
**7.3.3.1. If you have not recharged enough amounts to cover the arrearage since the arrearage is incurred for the first time, JD Cloud will suspend the service while retaining your NAT Gateway;**

**7.3.3.2. If you have not recharged enough amount to pay the arrearage after the expiration of the 7 days from the time of service suspension by JD Cloud (this period shall be computed from the suspension start moment of the date when services are suspended to the same moment of the 7th day), JD Cloud will terminate these Service Terms and clear your NAT Gateway.**

**7.3.4. You understand and fully accept that although JD Cloud has established, and will continue to improve according to the development of technology, necessary technical measures to protect against the matters or acts harmful to network security (hereinafter collectively referred to as such acts) including computer viruses, network intrusions, attack damages (including but not limited to DDOS****, NTP attacks****), in consideration of limitations and relativity of such network security technology and unpredictability of such acts, JD Cloud may decide to suspend or terminate the services if you bring any harm to JD Cloud or JD Cloud’s other networks or servers due to encountering such acts, including but not limited to local and foreign and international networks and servers, or affect the accessible communications between JD Cloud and the Internet, or between JD Cloud and specific networks and servers, or within JD Cloud. If the services are terminated, the service charge will be calculated based on the actual services provided, and you still shall pay the service charge you have not paid (if any).**

**7.3.5. JD Cloud may terminate these Service Terms by providing an announcement on **[**www.jdcloud.com**](https://www.jdcloud.com/index)** or sending you an on-site notice or a written notice to you in advance. At that time, JD Cloud shall refund the amount you have paid but not consumed to your JD Cloud account.**
