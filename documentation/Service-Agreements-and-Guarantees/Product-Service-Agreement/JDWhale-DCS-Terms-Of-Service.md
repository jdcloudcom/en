**These Service Terms are the effective contracts concluded by and between the owners of the Beijing Wodong Tianjun Information Technology Co., Ltd. (hereinafter referred to as "JD Cloud & AI" in the Agreement) and you on the matters related to the open product service of JDWhale DCS Product. You select to accept these Service Terms by sealing, clicking to confirm on the web page or other means, including but not limited to actually using open products\*service of JD Cloud & AI’s JDWhale DCS Product without clicking to confirm, indicating that you have reached an agreement with JD Cloud & AI and agreed to accept all agreed contents of these Service Terms. If the text sealed by the Parties is inconsistent with these Service Terms confirmed on the web page or selected to be accepted otherwise, the text sealed by the Parties shall prevail.**
...
1.1. For the purpose of these Terms, the "Service" means: [www.jdcloud.com](https://www.jdcloud.com/) the service of open product of JDWhale DCS Product, displayed on the website and provided by JD Cloud & AI, as well as relevant technology and network support service.

1.2. The service provided by JD Cloud & AI must comply with these Service Terms.
...
2.2. You need to pay the service in advance:
...
3.2.3 In case the service involves the open product service of JDWhale DCS Product of JD Cloud & AI, JD Cloud & AI is only responsible for the underlayer part under the operating system and the operation & maintenance of the software provided by JD Cloud & AI, namely technical architectures, operating systems and others related to open product service of JDWhale DCS Product. You shall be responsible for the part above the operating system (such as the application programs you install on your system). In addition, if you upgrade the operating system on your own, system breakdown and other adverse effects may be caused; please pay attention to the risk and be careful with the operation.
...
7.1. The term of service is calculated from the date when you successfully create any open product service of JDWhale DCS Product (the service shown and provided to you on jdcloud.com). The specific term of service will be calculated as per your actual usage.
...
11.2. JD Cloud & AI shall transfer all or part of the rights and obligations of these Service Terms to the affiliated companies of JD Cloud & AI by posting it on [www.jdcloud.com](https://www.jdcloud.com/) in advance or by sending you intra-website notices or written-form notices.
