**These Service Terms are the effective contract concluded by and between the integrated cloud computing service provider (hereinafter referred to as "JD Cloud") under JD Group and you for JCS for Greenplum and relevant matters. You select to accept these Service Terms by sealing, clicking to confirm on the web page or other means, including but not limited to actually using JCS for Greenplum services without clicking to confirm, indicating that you have reached an agreement with JD Cloud and agreed to accept all agreed contents of these Service Terms. If the text sealed by the Parties is inconsistent with the Service Terms confirmed on the web page or clicked to be accepted otherwise, the text sealed by the Parties shall prevail.**
...
1.1. For the purposes of these Terms, the "service" means: JD Cloud provides you with JCS for Greenplum Service as well as related technologies and network support services as displayed on the website [www.jdcloud.com](https://www.jdcloud.com).
...
You selected Pay-As-You-Go. Please view the page announcement on [www.jdcloud.com](https://www.jdcloud.com) for the specific deduction rules, which is subject to the current effective billing mode and standard announced on the page.
...
2.5 You understand and agree that JD Cloud has the right to unilaterally adjust the charge standard and charging method at any time according to the actual situation without obtaining your prior consent; JD Cloud will make the best efforts within the reasonable scope to notify you in advance of the aforementioned adjustments and changes by the official website [www.jdcloud.com](https://www.jdcloud.com) announcement, the intra-website notices or the contact information you provided; and the services purchased and paid in full amount before the adjustment date will not be affected.
...
3.1.3.5. Do not use the resources and services provided by JD Cloud JCS for Greenplum to upload, download, store and release the following information or contents, and do not provide any convenience for others to publish such information (including but not limited to setting URLs, Banner links, etc.):
...
**3.1.4.** **You understand and agree that the state secrets of the People’s Republic of China are protected by laws; you have the obligations to keep the state secrets of the People’s Republic of China confidential; your use of JCS for Greenplum shall comply with the requirements of laws and regulations related to confidentiality, and shall not damage the security of the state secrets of the People’s Republic of China, or you will be investigated under the relevant laws.**
...
**3.1.7.** **You are responsible for the content of data that you store on JD Cloud platform; JD Cloud notifies you to exercise caution in judging the legitimacy of data content, and conducts supervision on this; if the uploaded and stored contents are in violation of laws and regulations, department rules or national policies, you will be responsible for all the consequences, and system records of JD Cloud may be used as evidence of your violation of laws and regulations.**
...
**3.1.11.** **Data backup is your obligation and responsibility. JD Cloud JCS for Greenplum does not provide the data backup function, and users need to process the data backup by themselves. JD Cloud does not assume any responsibility for user data backup work or consequences.**
...
4.3. Unless statutory or otherwise agreed between JD Cloud and you, within 7 days from the suspension of the service due to your arrearage, JD Cloud will keep the data you’ve stored, and continue the billing, but all operations under your account are frozen; upon the expiration of 7 days from the suspension of service due to your arrearage (expiration of the period from the start time of suspension on the suspension date of the service to the same time on the 7th day), JD Cloud will no longer keep your data, and you shall be solely responsible for all consequences arising from the destroy of such data.
...
**7.3.2.1.** **You can continue using JD Cloud JCS for Greenplum Services for 24 hours from the time of the first arrear; if you still have not successfully recharged enough amount to cover the service charge after the expiration of the 24 hours, JD Cloud will suspend the service and freeze operation of JCS for Greenplum under your account with your data stored and billing continued;**

**7.3.2.2.** **If you still have not successfully recharged enough amount to pay the service charge after the expiration of the 7 days from the time of service suspension by JD Cloud (from the starting moment of the date of service suspension to the same moment of the 7th day is the expiration of the period), then JD Cloud will terminate these Service Terms and stop providing you with services; at the same time, all the data you stored on JD Cloud JCS for Greenplum will be deleted and cleared and can never be restored.**
...
**8.2.3.** **As for all or part of the functions of the JCS for Greenplum provided by JD Cloud to you free of charge, any service unavailability, error, vulnerability, etc. emerging and existing in these functions won’t be deemed as default of JD Cloud, and JD Cloud won’t bear any responsibilities for your work or result of using the free-of-charge functions of JCS for Greenplum, under the circumstance that JD Cloud has no intentional misconducts and major behavioral negligence.**

8.3. If you are unable to use the service for 72 consecutive hours due to causes of JD Cloud, you may terminate the service, except for reasons other than those within the control of JD Cloud.
...
**11.1.** **JD Cloud's service description, price description on relevant pages and the order page confirmed and agreed by you on [www.jdcloud.com](https://www.jdcloud.com) are integral of these Service Terms. If the service description and price description on relevant pages of JD Cloud on [www.jdcloud.com](https://www.jdcloud.com) and the order pages agreed and confirmed by you are inconsistent with these Service Terms, these Service Terms shall prevail.**
