**These Service Terms are the effective contracts concluded by and between the owners of the JD Cloud & AI website (referred to as "JD Cloud & AI" in the Agreement, website: [www.jdcloud.com](https://www.jdcloud.com/) ) and you on the matters related to the API Gateway. You select to accept these Service Terms by sealing, clicking to confirm on the web page or other means, including but not limited to actually using JD Cloud & AI's API Gateway service without clicking to confirm, indicating that you have reached an agreement with JD Cloud & AI and agreed to accept all agreements of these Service Terms. If the text sealed by the Parties is inconsistent with the Service Terms confirmed on the web page or clicked to be accepted otherwise, the text sealed by the Parties shall prevail.**
...
1.1 For the purposes of these Terms, the "service" means: JD Cloud & AI provides you with the API Gateway Service as well as related technologies and network support services as displayed on the website [www.jdcloud.com](https://www.jdcloud.com/).

1.2 The services provided by JD Cloud & AI must comply with these Service Terms.

### 2. Service Charge

2.1 The service charge will be listed and shown on your order page; you shall pay the corresponding service charge according to the current effective price system on the website of [www.jdcloud.com](https://www.jdcloud.com/).

2.2 The JD Cloud & AI API Gateway is a Pay-As-You-Go service: Once the service is enabled, JD Cloud & AI [www.jdcloud.com](https://www.jdcloud.com/) will provide service to you. JD Cloud & AI will issue the bill every day according to your actual usage of the previous day, and you need to pay the service charge to your JD Cloud & AI account as per the bill amount. See announcement in the page of [www.jdcloud.com](https://www.jdcloud.com/) for billing rules and the currently effective billing modes and standards announced on the page shall be followed.
...
If your websites use API Gateway service, you must guarantee that all websites you operate are licensed or approved by the relevant state departments;
...
3.2.3 In case the service involves the API Gateway, JD Cloud & AI is only responsible for the underlayer part under the API Gateway and the operation maintenance of the software provided by JD Cloud & AI, namely technical architectures, operating systems and others related to services of API Gateway service. You shall be solely responsible for the application part above the API Gateway. In addition, if you upgrade the operating system on your own, adverse effects may be caused; please take care of the risks and be careful to operate.
...
3.2.6 You understand and acknowledge that JD Cloud & AI will migrate the data center of API Gateway service which you use when necessary. JD Cloud & AI will notify you 7 natural days in advance before the above operations; since the above operations may require modifying DNS of relevant domain of yours, so you need to modify the DNS to the IP specified by JD Cloud & AI according to the time required by JD Cloud & AI upon receipt of the notification from JD Cloud & AI. Otherwise, you are responsible on your own in case the website application cannot be accessed.
...
7.1 The Service Term is calculated from the date you create any API Gateway service (the service shown to you on jdcloud.com) successfully; the specific term of service will be calculated based on your actual use, and the term of service shall be confirmed based on the amount of payment that you paid. After API Gateway service has been created successfully, where you need to make preparation before the website enabling (such as handling website operating license/website filing procedures, etc.), the preparation period is included in the Service Term.
...
7.2.3.1 You can continue using JD Cloud & AI API Gateway service for 24 hours from the time of the first arrear; if you still have not successfully recharged enough amount to cover the service charge after the expiration of the 24 hours, JD Cloud & AI will suspend the service and freeze operation of the API Gateway under your account with your data stored and billing continued;
...
7.2.5 JD Cloud & AI may terminate these Service Terms by advance announcement on [www.jdcloud.com](https://www.jdcloud.com/), website notice or written notification. At that time, JD Cloud & AI shall refund the amount you have paid but not consumed to your JD Cloud & AI account.
...
11.1 JD Cloud & AI's service description, price description and the ordering Page you confirm on [www.jdcloud.com](https://www.jdcloud.com/) are an integral part of these Service Terms. If the service description, price description and the order form you agree on the relevant pages at [www.jdcloud.com](https://www.jdcloud.com/) are inconsistent with these Service Terms, these Service Terms shall prevail.
