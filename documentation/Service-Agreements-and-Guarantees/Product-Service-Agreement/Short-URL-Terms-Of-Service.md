...
### 1. Service Content
1.1. For the purpose of these Terms, the "Service" means: Short URL Service provided by JD Cloud & AI to you as well as related technologies and network support service as displayed on the website [www.jdcloud.com](https://www.jdcloud.com).
...
2.2. Payment method: The pay-as-you-go method shall be adopted by calling quantity. Please view the page announcement on [www.jdcloud.com](https://www.jdcloud.com) for the specific deduction rules, which is subject to the effective billing mode and standard on the page at that time.
...
3.2.3 In case the service involves the Short URL, JD Cloud & AI is only responsible for the underlayer part under the operating system and the operation and maintenance of the software provided by JD Cloud & AI, namely technical architectures, operating systems and others related to service of Short URL. You shall be responsible for the part above the operating system (such as the application programs you install on your system). In addition, if you upgrade the operating system on your own, system breakdown and other adverse effects may be caused; please pay attention to the risk and be careful with the operation.
...
7.1. The term of service is calculated from the date when you successfully create any Short URL service (the service shown and provided for you on jdcloud.com). The specific term of service will be calculated as per your actual usage.
