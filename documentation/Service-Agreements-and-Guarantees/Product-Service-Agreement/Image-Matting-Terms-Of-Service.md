...
1.1. For the purpose of these Terms, the "Service" means: The Image Matting Service provided by JD Cloud & AI to you as well as related technical and network support service as displayed on the website [www.jdcloud.com](https://www.jdcloud.com).
...
3.1.3.2 You shall use various design output provided by JD Cloud & AI Image Matting Service as legally authorized. The scope of authority shall be subject to the notification on the web page. Any use exceeding the scope of authority shall be permitted by the relevant obligees.
...
3.1.3.4 JD Cloud & AI Image Matting Service grants users non-exclusive and non-transferable rights of using the materials. During using JD Cloud & AI Image Matting Service, you must comply with the following general rules:
...
3.2.6 If your service is terminated by any of the above parties due to breach of any agreement, rule, announcement and other relevant provisions of JD Cloud & AI and its affiliated companies, so that you are unable to normally use the Image Matting Service, JD Cloud & AI shall be entitled to take corresponding measures as the case may be, including but not limited to immediately terminating the services, suspending the services or deleting the corresponding information.
...
7.1. You may use JD Cloud & AI Image Matting Service since the date when you successfully enable any of the Image Matting services (the services shown and provided for you on jdcloud.com). The specific consumption will be calculated as per your actual usage.
...
You can continue using JD Image Matting Service for 24 hours from the time of the first arrear; if you still have not successfully recharged enough amount to pay the service charges in arrears after the expiration of the 24 hours, JD Cloud & AI will suspend the services until you recharge and pay the service charges in arrears;
