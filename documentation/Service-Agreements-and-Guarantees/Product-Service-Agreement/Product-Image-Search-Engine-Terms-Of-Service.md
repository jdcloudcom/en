**<div align=center>Service Terms of Commodity Image Search</div>**

**These Service Terms are the effective contracts concluded by and between the owners of the Beijing Wodong Tianjun Information Technology Co., Ltd. (hereinafter referred to as "JD Cloud & AI" in the Agreement) and you on the matters related to the service of Commodity Image Search. You select to accept these Service Terms by sealing, clicking to confirm on the web page or other means, including but not limited to actually using JD Cloud & AI’s Commodity Image Search service without clicking to confirm, indicating that you have reached an agreement with JD Cloud & AI and agreed to accept all agreed contents of these Service Terms. If the text sealed by the Parties is inconsistent with these Service Terms confirmed on the web page or selected to be accepted otherwise, the text sealed by the Parties shall prevail.**
...
1.1. For the purpose of these Terms, the "Service" means: Commodity Image Search provided by JD Cloud & AI to you as well as related technologies and network support service as displayed on the website [www.jdcloud.com](https://www.jdcloud.com).

1.2. The service of Commodity Image Search of JD Cloud & AI, based on the 100-million level commodity data training models of JD, supports customized commodity image library and is capable of searching the same or similar commodities from the library under various scenarios, thus facilitating the user to do some shopping on the e-commerce platform by shooting.

1.3. The service provided by JD Cloud & AI must comply with these Service Terms.
...
2.2.1.2. If the Parties are willing to continue cooperation after the expiration of the term of service, you shall pay the renewal charges not later than 7 days before the expiration of the term of service so as to continue the services. If JD Cloud & AI has adjusted the product system, names or prices at the time of renewal, the Parties agree to perform the new product systems, names or prices that are effective at that time.

2.2.2. Pay-As-You-Go

You can pay for the costs afterwards. Please view the page announcement on [www.jdcloud.com](https://www.jdcloud.com) for the specific deduction rules, which is subject to the effective billing mode and standard of Pay-As-You-Go services on the page at that time.
...
**3.1.3.6 Do not use the resources and service provided by JD Cloud & AI to upload, download, store and release the following information or contents, and do not provide any convenience for others to publish such information (including but not limited to setting URL, BANNER links, etc.):**
...
3.2.3 In case the service involves Commodity Image Search, JD Cloud & AI is only responsible for the underlayer part under the operating system and operation & maintenance of the software provided by JD Cloud & AI, namely technical architectures, operating systems and others related to service of Commodity Image Search. You shall be responsible for the part above the operating system (such as the application programs you install on your system). In addition, if you upgrade the operating system on your own, system breakdown and other adverse effects may be caused; please pay attention to the risk and be careful with the operation.
...
4.3. Unless otherwise agreed by law and between JD Cloud & AI and you, JD Cloud & AI shall continue to store your data for 7 natural days since the expiration of these Service Terms or the early termination thereof due to any reason, but will no longer keep your data thereafter. You shall bear all the consequences by yourself arising from the destruction of your data.
...
6.3. The Parties to these Service Terms expressly acknowledge that the confidential information is key confidential information and important assets of each Party, and agree to use their best endeavors to prevent such confidential information from being disclosed. In the event of divulgence of such confidential information, the Parties shall cooperate with each other to take all reasonable measures to avoid or mitigate any damage.

6.4. The Article shall survive the termination of these Service Terms.

### **7.** Subscription, Use and Termination of the Service

7.1. The term of service is calculated from the date when you successfully create any service of Commodity Image Search [it is able to confirm that the service can be created at the business side one by one] (the service shown and provided for you on jdcloud.com). The specific term of service will be calculated as per your actual usage.
...
8.2. You understand that due to the particularity of computers and the Internet, JD Cloud & AI will not be deemed as breach of these Terms in the following cases:
...
8.4. JD Cloud & AI's total liability for breach of these Service Terms shall not exceed the total service charge corresponding to the breach service in any case.
