**These Service Terms are the effective contract concluded by and between the owner of the JD Cloud website (referred to as "JD Cloud" in the Agreement, website: [www.jdcloud.com](https://www.jdcloud.com) and you on the matters related to the IoT Edge** **service. You select to accept these Service Terms by sealing, clicking to confirm on the web page or other methods, including but not limited to actually using JD Cloud IoT Edge** **service without clicking to confirm these Service Terms, indicating that you have reached an agreement with JD Cloud and agree to accept all agreed contents of these Service Terms. If the text sealed by the Parties is inconsistent with the Service Terms confirmed on the web page or clicked to be accepted otherwise, the text sealed by the Parties shall prevail.**
...
1.1. "Service" in these Terms means: JD Cloud provides you with the IoT Edge service and related technical and network support services displayed on [www.jdcloud.com](https://www.jdcloud.com).
...
3.2.3 In case the service involves IoT Edge, JD Cloud is only responsible for the underlayer under the operating system and the operation maintenance of the software provided by JD Cloud, namely the related technical architecture and operating system of IoT Edge service. The part above the operating system (such as the application program you install on your system) is your own responsibility. In addition, if you upgrade the operating system on your own, system breakdown and other adverse effects may be caused; please take care of the risks and be careful to operate.
