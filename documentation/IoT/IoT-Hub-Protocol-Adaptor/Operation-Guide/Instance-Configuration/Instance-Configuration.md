...
You can create rules through the IoT Hub Protocol Adaptor Service  Console or API. This document introduces how to configure a service instance through the Console.
