...
You can quickly delete the IoT Hub instance through the IoT Hub Protocol Adaptor Service  Console or API.

This document introduces how to delete an IoT Hub Protocol Adaptor Service  instance through the Console.
...
- Created IoT Hub Protocol Adaptor Service  Instance.
