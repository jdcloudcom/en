...
You can view the IoT Hub instance through the IoT Hub Protocol Adaptor Service  Console or API.

This document introduces how to view the IoT Hub Protocol Adaptor Service  instance list through the Console.
