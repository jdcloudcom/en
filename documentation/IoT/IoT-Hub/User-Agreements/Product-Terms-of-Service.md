# IoT Hub Service  Terms

**These Service Terms are the effective contracts concluded by and between the owners of the JD Cloud website (referred to as "JD Cloud" in the Agreement, website: https://www.jcloud.com) and you on the matters related to the IoT Hub Service. You accept these Service Terms by sealing, clicking the web page to confirm on the web page or other means, including but not limited to actually using the JD Cloud IoT Hub Service without clicking to confirm, indicating that you have reached an agreement with JD Cloud and agreed to accept all agreed contents of these Service Terms. If the text sealed by the Parties is inconsistent with the Service Terms confirmed on the web page or clicked to be accepted otherwise, the text sealed by the Parties shall prevail.**
...
1.1. "Service" in these Terms means: IoT Hub Service and related technical and network support services displayed on www.jdcloud.com and provided by JD Cloud for you.

1.2. The service provided by JD Cloud must comply with the agreement in these Service Terms.

**2.** **Service Charge**

2.1. During the Beta, the charge of the IoT Hub Service is subject to the announcement of the official website.
...
7.1.	 The Service Term is calculated from the date when you successfully create any IoT Hub Service (the service shown and provided for you on jdcloud.com). The specific term of service will be calculated as per your actual usage.
...
7.3.2. JD Cloud will stop providing such IoT Hub Protocol Adaptor Service if you shut down any IoT Hub Service; if you shut down any IoT Hub Service, these Service Terms will be terminated;
