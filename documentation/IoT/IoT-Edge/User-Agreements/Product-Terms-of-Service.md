...
1.1. “Service” in these Terms means: JD Cloud provides you with the IoT Edge service and related technical and network support services displayed on www.jdcloud.com.

1.2. The service provided by JD Cloud must comply with the agreement in these Service Terms.

## 2.      Service Charge         

2.1. During the beta, the charge of the IoT Edge service is subject to the announcement of the official website.
...
7.3.2 Once any IoT Edge service is disabled by you, JD Cloud will stop provision of the service; once all IoT Intelligent Edge Computing is disabled by you, these Service Terms will terminate;
