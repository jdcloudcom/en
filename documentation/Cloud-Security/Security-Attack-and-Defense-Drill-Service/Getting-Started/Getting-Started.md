# Getting Started
Log in the official website of JD Cloud and fill in and open ticket to apply for using the Security Defense Drilling service. 
...
Log in JD Cloud "Security Defense Drilling Service" product page and click **Ticket Consultation** to fill in the Security Defense Drilling service application form. After completion, click **Submit** to complete the on-line application.
...
Users are provided with the Security Defense Drilling service by JD Cloud security experts or third-party security teams.
