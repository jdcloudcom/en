# Getting Started
By logging in the official website of JD Cloud, filling in and opening ticket to apply for using penetration test service. 
...
Log in JD Cloud “Penetration Test Service” product page and click **Ticket Consultation** to fill in the penetration test service application form. After completion, click **Submit** to complete the on-line application.
...
JD Cloud security experts will implement the penetration test service for users.

### Step 6: Submission of report
At the end of the service implementation, the service personnel will prepare a detailed penetration test report and submit it to the user.
