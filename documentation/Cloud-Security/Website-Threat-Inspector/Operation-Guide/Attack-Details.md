...
- Operation Steps
Cloud assets under your account of [JD Cloud]***\***@[jdcloud.com](https://jdcloud.com/) can be received via an SMS: *.win2012-bj; if the incident is found: The web is subject to DDoS attack, please log in JD Cloud-Situation Awareness for incident response.
...
Note: The event with the 【Ignore】 tag will not be displayed again the in the user console. The incident with the [False Alarm] tag will be displayed again the in the console. Sometimes, when the user intends to search historical events, the filtration can be made on the level and status basis. The level can be divided into the emergency level and the convention level.
...
- Operation Steps
Cloud assets under your account of [JD Cloud] ***\***@[jdcloud.com](https://jdcloud.com/) can be received via an SMS: *.win2012-bj, if the Web targeted attack threat is found, please log in JD Cloud-Situation Awareness for incident response.

 - Quick Search
Alarm events concerned can be quickly searched on the basis of account asset, time period of details and attack type. The event trend of recent period and of the same type can be conveniently viewed by the attack trend.
Click [Threat Details] -> [Actions] -> [Details and Suggestions] and the page will jump to the [Details of Threat Model]. View details of targeted attack event.
Click the attack event of each stage to redirect to the Alarm Incident Details page.
Click the return key to go back to the page of [Threat Details].

- Incident Handling
If the user makes the judgment based on details of the event feedback, please click corresponding buttons for false alarm, ignoring or confirming the event judgment. If the user attaches special focus on a certain event, the user can provide the feedback via a ticket. The backend operation and maintenance personnel of JD Cloud will analyze causes and provide answers.
        - Note: The event with the 【Ignore】 tag will not be displayed again the in the user console. The incident with the [False Alarm] tag will be displayed again the in the console. Sometimes, when the user intends to search historical events, the filtration can be made on the level and status basis. The level can be divided into the severe level, the doubtful level and the prompting level.
