# Getting Started
Log in the official website of JD Cloud and fill in and open ticket to apply for using the security notification service. 
...
Log in JD Cloud "Security Notification Service" product page and click **Ticket Consultation** to fill in the security notification service application form. After completion, click **Submit** to complete the on-line application.
...
Users are provided with the security notification service by JD Cloud Security Team.
