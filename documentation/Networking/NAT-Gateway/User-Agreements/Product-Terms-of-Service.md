...
1.1. For the purposes of these Terms, the "service" means: JD Cloud provides you with NAT Gateway Service as well as related technologies and network support services as displayed on the website www.jdcloud.com.
...
3.1.3.6. Do not be occupy or cause programs or processes to occupy a large amount of the server memory, CPU or network bandwidth resources on the platform (hereinafter referred to as the "cloud platform") consisting of JD Cloud's cloud computing resources (such as cloud servers, network bandwidth, and bucket), cause serious load on the networks, servers (including but not limited to local and foreign and international networks, servers, etc.), products/applications, etc. of the users of JD Cloud's cloud platform or other users of JD Cloud, affect the smooth communications between JD Cloud and the Internet or between JD Cloud specific and networks and servers and internal smooth communication within JD Cloud, or cause the system breakdown or system halt of the servers that the products and services of JD Cloud's cloud platform or other user websites of JD Cloud are on, or failure of access of users to the products/applications based on the cloud platform, etc.;
...
7.1. Service Term You can immediately use JD Cloud's NAT Gateway service from the date when you enable the NAT Gateway service (it refers to the service displayed and provided for you on www.jdcloud.com). The specific Service Term will be calculated according to your actual use.
