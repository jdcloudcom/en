...
The ENI of JD Cloud & AI (including primary network interface and secondary network interface) supports canceling association security group and at least one security group shall be kept.
