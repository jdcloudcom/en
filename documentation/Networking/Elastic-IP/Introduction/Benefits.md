...
Users can select an appropriate billing type, according to business requirements, from the types of payment by monthly package, payment by configuration and payment by consumption.
