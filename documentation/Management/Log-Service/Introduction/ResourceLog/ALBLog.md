...
-- | -- | -- | --
timestamp  | Time stamp | string | accurate to millisecond, eg: 2018-12-20T02:59:40.001
alb_id | Load Balancer ID| string | alb-[0-9][a-z]{10} , eg: alb-gmjnqw8bnh
client_ip | Client ip | string | eg: 192.168.10.1
client_port | Client port  | double | 1-65535, eg: 50398
lb_vip | Load Balancer virtual ip (vip) | string | eg: 192.168.10.2
lb_vport | Load Balancer Listener port (vport) | double | 1-65535, eg: 8080
backend_server_ip_port | ip and port of Backend Server | string | eg: 192.168.10.1:8080
request_time | Request time | double | >0, eg: 0.006
backend_connect_time | Connection setup time | double | >0, eg: 0.001
backend_response_time | Response time | double | >0, eg: 0.006
status | Status Code | double | similar to http code; eg: 200, 404, 503 ....
backend_server_status | Return Status Code of Backend Server | double | similar to http code; eg: 200, 404, 503 ....
request_length | Request data length | double | >0, eg: 80
bytes_sent | Sent data | double | >0, eg: 197
