# License Rules in Jiangxi

### Rules of Unit Filing in Jiangxi:
...
3. **When the responsible person has no Jiangxi ID card, Jiangxi residence permit of the person shall be provided**
...
### Rules of Personal Filing in Jiangxi:

1. The address on the certificate must be within the province. The ID card of another province cannot be used for applying for the license and the license application by any foreigner will be rejected

2. **The checklist must be signed with signature and red fingerprint**
