# **License Rules in Gansu**

### License Rules for Organization in Gansu

1. Enterprises must use the new documents integrating the three certificates to perform filing

2. **The person in charge is the legal person

3. If the person in charge of the website is not the legal person, please be sure to submit [Power of Attorney for Person in Charge of Entity.doc](https://badownload.s3.cn-north-1.jdcloud-oss.com/buchongziliao/fujian/fujianshouquanshu.doc)

4. All mobile numbers of responsible person must be the number of Gansu.
