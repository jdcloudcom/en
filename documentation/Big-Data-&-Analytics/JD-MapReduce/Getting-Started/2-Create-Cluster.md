...
## Operation Steps
1. Log in to the [JD MapReduce Console](https://xdata.jdcloud.com/rmgr/resources/res-manage/custom-resources.html#/) and select the region. JMR only supports cn-north-1 and cn-south-1 now. More regions will be supported subsequently.
	   
2. Click **Create** in the cluster management page to enter the creation page.

3. Click **Buy Now**, and the page shall automatically jumps to the JMR cluster management page to wait for cluster creation completion.
