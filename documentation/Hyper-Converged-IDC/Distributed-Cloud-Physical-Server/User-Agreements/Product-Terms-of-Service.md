...
**The Service Terms is the valid agreement made by the owner of JD Cloud website (referred to as "JD Cloud" in this Agreement, website: www.jdcloud.com
and you on the matters related to cloud physical server service. You select to accept these Service Terms by sealing, clicking to confirm on the web page or other means, including but not limited to actually using JD Cloud's cloud physical server service without clicking to confirm, indicating that you have reached an agreement with JD Cloud and agree to accept all agreed contents of these Service Terms. If the text sealed by the Parties is inconsistent with the Service Terms confirmed on the web page or clicked to be accepted otherwise, the text sealed by the Parties shall prevail.**
...
If you establish and operate multiple websites on the cloud physical server service, you must guarantee that all websites you operate are licensed or approved by the relevant state departments;
...
3.1.3.8 Do not be occupy or cause programs or processes to occupy a large amount of the server memory, CPU or network bandwidth resources on the platform (hereinafter referred to as the "cloud platform") consisting of JD Cloud's cloud computing resources (such as cloud physical server, network bandwidth and storage space), cause serious and unreasonable load on the networks, servers (including but not limited to local and foreign and international networks, servers, etc.), products/applications, and others of the users of JD Cloud's cloud platform or other users of JD Cloud, affect the normal and smooth communications between JD Cloud and the Internet or JD Cloud between specific networks, servers and JD Cloud internal, or cause the system breakdown or system halt of the servers that the products and services of JD Cloud's cloud platform or other user websites of JD Cloud are on, or failure of access of users to the products/applications based on the cloud platform, etc.;
...
3.1.3.10 You are obligated to ensure that the cloud physical server are not affected by security vulnerabilities; with regard to the notice of vulnerability patch issued by JD Cloud, you shall be proactive in taking remedial measures to eliminate the impact; JD Cloud shall not bear any responsibility in case the cloud physical server is attacked due to security vulnerability (including but not limited to suffering from intrusions, broilers, denial of service, etc.).
...
3.1.5. You are responsible for the data stored by yourself on JD Cloud's cloud platform as well as the integrity and confidentiality of the passwords of entering and managing the products and services on the JD Cloud's cloud platform. All losses and consequences caused by the loss or leakage of the above data, passwords and others due to your improper maintenance or improper confidentiality shall all be borne by you.
...
3.2.6 You understand and acknowledge that JD Cloud will migrate the machine room of the cloud physical server service which you use when necessary. JD Cloud will notify you 7 natural days in advance before the above operations; since the above operations may require modifying DNS of relevant domain of yours, so you need to modify the DNS to the IP specified by JD Cloud according to the time required by JD Cloud upon receipt of the notification from JD Cloud. Otherwise, you are responsible on your own in case the website application cannot be accessed.
