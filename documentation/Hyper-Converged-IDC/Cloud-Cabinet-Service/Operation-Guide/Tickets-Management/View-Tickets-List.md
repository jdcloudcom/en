...
![To view the My Open Ticket page, click the link](https://github.com/jdcloudcom/cn/blob/cn-Cloud-Cabinet-Service/image/Hyper-Converged-IDC/Cloud-Cabinet-Service/CCS009.jpg)

# View the Tickets Details

Click on the **View** in the tickets list to skip to the Ticket Details page, as shown below
![To view the open ticket details, click the link](https://github.com/jdcloudcom/cn/blob/cn-Cloud-Cabinet-Service/image/Hyper-Converged-IDC/Cloud-Cabinet-Service/CCS008.jpg)
