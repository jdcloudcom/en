...
- Database Type: Currently, it supports three database types, namely, MySQL, SQL Server, Percona and MariaDB, and different regions support different database types, which shall be subject to the console.
